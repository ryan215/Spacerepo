...
class Finance_retailer_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->superAdminCustomView('admin/finance_retailer_managements/balance_available_list',$this->data);
	}
	...
	public function balance_available_view($organizationId=0)
	{
		...
		$this->superAdminCustomView('admin/finance_retailer_managements/balance_available_view',$this->data);
	}
	...
	public function balance_available_ledger_view($organizationId=0)
	{
		...
		$this->data['organizationId'] = $organizationId;
		$this->superAdminCustomView('admin/finance_retailer_managements/balance_available_ledger_view',$this->data);
	}
	...
	public function initiate_payment($organizationId=0)
	{
		...
		$this->data['organizationId'] = $organizationId;
		$this->superAdminCustomView('admin/finance_retailer_managements/initiate_payment',$this->data);
	}
	...
	public function processing_balance()
	{
		...
		$this->superAdminCustomView('admin/finance_retailer_managements/balance_processing_list',$this->data);
	}
	...
	public function balance_processing_view($organizationId=0)
	{
		...
		if(!$organizationId)
		{
			redirect(base_url().'superadmin/finance_retailer_management/processing_balance');
		}
		
		$this->data['result']     = $this->finance_retailer_lib->balance_processing_view($organizationId);
		$this->data['organizationId'] = $organizationId;
		$this->superAdminCustomView('admin/finance_retailer_managements/balance_processing_view',$this->data);
	}
	...
	public function reference_number($organizationId=0,$financeRetailerIniPayId=0)
	{
		...
		$this->data['organizationId'] = $organizationId;
		$this->superAdminCustomView('admin/finance_retailer_managements/reference_number',$this->data);
	}
	...
	public function paid_balance()
	{
		...
		$this->superAdminCustomView('admin/finance_retailer_managements/balance_paid_list',$this->data);
	}
	...
	public function balance_paid_view($organizationId=0)
	{
		...
		if(!$organizationId)
		{
			redirect(base_url().'superadmin/finance_retailer_management/paid_balance');
		}
		
		$this->data['result']     = $this->finance_retailer_lib->balance_paid_view($organizationId);
		$this->data['organizationId'] = $organizationId;
		$this->superAdminCustomView('admin/finance_retailer_managements/balance_paid_view',$this->data);
	}
	
	public function test()
	{
		$this->superAdminCustomView('admin/finance_retailer_managements/test2',$this->data);
	}
}