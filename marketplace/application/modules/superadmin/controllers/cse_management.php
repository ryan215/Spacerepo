...
class Cse_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->superAdminCustomView('admin/cse_managements/cse_list',$this->data);
	}
	...
	public function ajaxFun($total=0)
	{
		...
		$this->load->view('admin/cse_managements/ajaxPagView',$this->data);
	}
	...
	public function addCse()
	{
		...
		$this->data['imageUploadPath'] = base_url().'superadmin/cse_management/upload_cse_image/';
		$this->superAdminCustomView('admin/cse_managements/addCse',$this->data);
	}
	...
	//echo "<pre>";	print_r($this->data['result']); exit;
		$this->superAdminCustomView('admin/cse_managements/editCse',$this->data);
	}
	...
	public function user_detail($employeeId)
	{
		...
		$this->superAdminCustomView('admin/cse_managements/user_details',$this->data);	
	}
	...
	public function unblock_block($employeeId,$status)
	{
		...
		redirect(base_url().'superadmin/cse_management/user_detail/'.id_encrypt($employeeId));
	}
