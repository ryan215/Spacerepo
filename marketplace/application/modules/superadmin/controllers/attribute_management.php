...
class Attribute_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->superAdminCustomView('admin/attribute_managements/attribute_listing',$this->data);
	}
	...
	public function attributeListingAjaxFun($total=0)
	{
		...
		$this->data['result'] = $result;
		$this->load->view('admin/attribute_managements/attributeListingAjaxFun',$this->data);
	}
	...
	public function view_attribute_list($productTypeId)
	{
		...
		$this->superAdminCustomView('admin/attribute_managements/view_attribute_list',$this->data);
	}
	...
	public function addAttributeList()
	{
		...
		$this->data['result'] = $result;
		$this->superAdminCustomView('admin/attribute_managements/addAttributeList',$this->data);
	}
	...
	public function editAttributeList($productTypeId=0)
	{
		...
		$this->data['result'] = $result;
		$this->superAdminCustomView('admin/attribute_managements/editAttributeList',$this->data);
	}	
}