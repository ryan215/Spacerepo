...
class Finance_vendor_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->superAdminCustomView('admin/finance_vendor_managements/balance_available_list',$this->data);
	}
	...
	public function balance_available_view($shippingOrgId=0)
	{
		...
		if(!$shippingOrgId)
		{
			redirect(base_url().'superadmin/finance_vendor_management');
		}
		
		$this->data['result']     = $this->finance_vendor_lib->vendor_user_details($shippingOrgId);
		$this->data['shippingOrgId'] = $shippingOrgId;
		$this->superAdminCustomView('admin/finance_vendor_managements/balance_available_view',$this->data);
	}
	...
	public function initiate_payment($shippingOrgId=0)
	{
		...
		$this->data['shippingOrgId'] = $shippingOrgId;
		$this->superAdminCustomView('admin/finance_vendor_managements/initiate_payment',$this->data);
	}
	...
	public function processing_balance()
	{
		...
		$this->superAdminCustomView('admin/finance_vendor_managements/balance_processing_list',$this->data);
	}
	...
	public function balance_processing_view($shippingOrgId=0)
	{
		...
		if(!$shippingOrgId)
		{
			redirect(base_url().'superadmin/finance_vendor_management/processing_balance');
		}
		
		$this->data['result']     = $this->finance_vendor_lib->balance_processing_view($shippingOrgId);
		$this->data['shippingOrgId'] = $shippingOrgId;
		$this->superAdminCustomView('admin/finance_vendor_managements/balance_processing_view',$this->data);
	}
	...
	public function reference_number($shippingOrgId=0,$financeVendorIniPayId=0)
	{
		...
		$this->data['shippingOrgId'] = $shippingOrgId;
		$this->superAdminCustomView('admin/finance_vendor_managements/reference_number',$this->data);
	}
	...
	public function paid_balance()
	{
		...
		$this->superAdminCustomView('admin/finance_vendor_managements/balance_paid_list',$this->data);
	}
