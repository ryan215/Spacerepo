...
class Shipping_bounce extends MY_Controller {
	...
	public function index()
	{
		...
		$this->superAdminCustomView('admin/shipping_bounce/shipping_bounce_list',$this->data);
	}
	...
	public function ajaxFun($total=0)
	{
		...
		$this->load->view('admin/shipping_bounce/ajaxPagView',$this->data);
	}
	...
	public function delete_shipping_bounce($shippingBounceId=0)
	{
		...
		redirect(base_url().'superadmin/shipping_bounce');
	}
}