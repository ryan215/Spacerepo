...
class Order_management extends MY_Controller {
	...
	{	
		...
		$this->superAdminCustomView('order_managements/orders_list',$this->data);
	}
	...
	public function ajaxFun()
	{
		...
		$this->load->view('order_managements/order_ajax',$this->data);
	}	
	...
	public function order_view($orderId=0)
	{
		...
		$this->superAdminCustomView('order_managements/order_view',$this->data);
	}
	...
	public function pickup_print_invoice()
	{
		...
		$this->data['result'] = $result;
		echo $this->load->view('order_managements/pickup_print_invoice',$this->data,true);
	}
	...
	public function pickup_print_page()
	{
		...
		$result	 = $this->order_pickup_lib->pickup_order_view($orderID,2);
		$this->data['result'] = $result;
		echo $this->load->view('order_managements/pickup_print_page',$this->data,true);
	}
	...
	public function delivery_print_invoice()
	{
		...
		$this->data['result'] = $result;
		echo $this->load->view('order_managements/delivery_print_invoice',$this->data,true);
	}
		...
		public function economic_delivery_print_invoice()
	{
		...
		echo $this->load->view('order_managements/economic_delivery_print_invoice',$this->data,true);
	}
	...
	public function delivery_print_page()
	{
		...
		$result	 = $this->order_lib->order_view($orderID,3); //echo "<pre>"; print_r($result); exit;
		$this->data['result'] = $result;
		echo $this->load->view('order_managements/delivery_print_page',$this->data,true);
	}
		...
		public function economic_order_view($orderId=0)
	{
		...
		$this->data['result']  = $result;
		$this->data['orderId'] = $orderId;
		$this->superAdminCustomView('order_managements/economic_order_view',$this->data);
	}
