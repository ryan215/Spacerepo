...
class Vendor_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->superAdminCustomView('admin/vendor_managements/vendore_list',$this->data);
	}
	...
	public function ajaxFun($total=0)
	{
		...
		$this->load->view('admin/vendor_managements/ajaxPagView',$this->data);
	}
	...
	public function addVendore()
	{
		...
		$this->data['imageUploadPath'] = base_url().'superadmin/vendor_management/upload_image/';
		$this->superAdminCustomView('admin/vendor_managements/addVendore',$this->data);	
	}
	...
	public function user_detail($organizationId)
	{
		...
		$this->superAdminCustomView('admin/vendor_managements/user_details',$this->data);
	}
	...
	public function editVendor($organizationId=0)
	{
		...
		$this->data['imageUploadPath'] = base_url().'superadmin/vendor_management/upload_image/';
		$this->data['organizationId']  = $organizationId;
		$this->superAdminCustomView('admin/vendor_managements/editVendor',$this->data);
	}
	...
	public function addShippingRates($shippingOrgId=0)
	{
		...
		if(!empty($shippingOrgId))
		{
			...
			$this->superAdminCustomView('admin/vendor_managements/addShippingRates',$this->data);	
		}
	}
	...
	public function edit_rate($shippingRateId=0)
	{
		...
		$this->superAdminCustomView('admin/vendor_managements/editRate',$this->data);		
	}
	...
	public function shipping_rate_list($shippingOrgId)
	{
		...
		$this->data['shippingOrgId'] = $shippingOrgId;
		$this->superAdminCustomView('admin/vendor_managements/shipping_rates_list',$this->data);
	}
	...
	public function shippingRatesAjaxFun($total=0)
	{
		...
		$this->load->view('admin/vendor_managements/shipping_rates_list_ajax',$this->data);	
	}
	...
	public function addShippingRatesFrom10To30($shippingOrgId)
	{
		...
		$this->data['shippingOrgId'] = $shippingOrgId;
		$this->superAdminCustomView('admin/vendor_managements/addShippingRatesFrom10To30',$this->data);
	}
}