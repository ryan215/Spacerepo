...
class Customer_management extends MY_Controller {
	...
	{	
		...
		$this->data['title'] = 'Customer Management';
		$this->superAdminCustomView('customer_managements/customer_list',$this->data);
	}
	...
	public function ajaxFun()
	{
		...
		$this->load->view('customer_managements/ajaxPagView',$this->data);
	}
	...
	public function user_detail($customerId)
	{
		...
		$this->superAdminCustomView('customer_managements/user_details',$this->data);	
	}
	...
	public function order_list($customerId)
	{
		...
		$this->custom_log->write_log('custom_log','customer user id is '.$customerId);
		$this->data['customerId'] = $customerId;
		$this->superAdminCustomView('customer_managements/order_list',$this->data);
	}
	...
	public function orderAjaxFun()
	{
		...
		$this->data['customerId'] = $customerId;
		$this->load->view('customer_managements/orderAjaxPagView',$this->data);
	}
	...
	{	
		...
		$this->data['customerId'] = $customerId;
		$this->superAdminCustomView('customer_managements/order_details',$this->data);
	}
}