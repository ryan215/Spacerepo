...
class News_subscription_email extends MY_Controller {
	...
	public function index()
    {
		...
		$this->superAdminCustomView('admin/news_subscription_emails/compose_mail',$this->data);
    }
	...
	public function mail_history_list()
    {
		...
		$this->data['result'] = $this->news_subscription_email_lib->total_subscribe_with_unsubscribe_list();
		$this->superAdminCustomView('admin/news_subscription_emails/mail_history_list',$this->data);
    }
	...
	public function ajax_mail_history_list()
    {
		...
		$this->load->view('admin/news_subscription_emails/mail_history_ajax_list',$this->data);
	}
	...
	public function subscribe_list()
    {
		...
		$this->data['result'] = $this->news_subscription_email_lib->total_subscribe_with_unsubscribe_list();
		$this->superAdminCustomView('admin/news_subscription_emails/subscribe_list',$this->data);
    }
	...
	public function ajax_subscribe_list()
    {
		...
		$this->load->view('admin/news_subscription_emails/subscribe_ajax_list',$this->data);
	}
	...
	public function unsubscribe_list()
    {
		...
		$this->data['result'] = $this->news_subscription_email_lib->total_subscribe_with_unsubscribe_list();
		$this->superAdminCustomView('admin/news_subscription_emails/unsubscribe_list',$this->data);
    }
	...
	public function ajax_unsubscribe_list()
    {
		...
		$this->load->view('admin/news_subscription_emails/unsubscribe_ajax_list',$this->data);
	}	
}
