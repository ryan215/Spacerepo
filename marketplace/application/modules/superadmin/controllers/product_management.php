...
class Product_management extends MY_Controller {
	...
	public function index($organizationId=0)
	{
		...
		$this->superAdminCustomView('product_managements/product_list',$this->data);
	}
	...
	public function addEditProduct($product_id='')
	{
		...
		$this->superAdminCustomView('product_managements/add_edit_product',$this->data);
	}
	...
	public function addEditProductImage($product_id='')
	{
		...
		if(empty($product_id))
		{
			...
			redirect(base_url().'superadmin/product_management/addEditProduct');
		}
		...
		$this->superAdminCustomView('retailer/product_managements/addEditProductImage',$this->data);
	}
	...
	public function addEditProductAttribute($product_id='')
	{
		...
		$this->superAdminCustomView('retailer/product_managements/addEditProductAttribute',$this->data);
	}
	...
	public function productReview($product_id='')
	{
		...
		$this->data['product_id'] = $product_id;
		//echo "<pre>"; print_r($result); exit;
		$this->superAdminCustomView('product_managements/product_review',$this->data);
	}
	...
	public function deleteImage($productImageId='',$product_id='')
	{
		...
		if(empty($productImageId))
		{
			...
			redirect(base_url().'superadmin/product_management/addEditProductImage/'.$product_id);
		}
	...
	public function makeMainImage($productImageId='',$product_id='')
	{
		...
		{
			$this->session->set_flashdata('error',$this->lang->line('error_product_image_id_not'));
			redirect(base_url().'superadmin/product_management');
		}
		...
		redirect(base_url().'superadmin/product_management/addEditProductImage/'.id_encrypt($product_id));		
	}
	...
	public function unblock_block($product_id,$status)
	{
		...
		redirect(base_url().'superadmin/product_management/view/'.id_encrypt($product_id));
	}
	...
	public function view($product_id='',$organizationId='')
	{
		...
		if($_POST)
		{
			...
			if($action=='send_back')
			{
				...
				if($this->form_validation->run())
				{
					...
					redirect(base_url().'superadmin/product_management/review/'.id_encrypt($product_id).'/view/retailer');
				}
			}
		...
		//echo "<pre>"; print_r($result); exit;
		$this->data['organizationId']    = $organizationId;
		$this->superAdminCustomView('admin/product_managements/product_view',$this->data);
	}
	...
	public function review($product_id='')
	{
		...
		$this->superAdminCustomView('admin/product_managements/product_review',$this->data);
	}	
	...
	public function check_stocks($organizationId=0)
	{
		...
		$this->data['organizationId'] = $organizationId;
		$this->superAdminCustomView('retailer/product_managements/check_stocks',$this->data);
	}
	...
	public function inventory_details($organizationProductId=0,$organizationId=0)
	{
		...
		$this->data['organizationId']  = $organizationId;
		$this->superAdminCustomView('retailer/product_managements/inventory_details',$this->data);
	}
	...
	public function add_inventory($organizationId=0,$productId=0)
	{
		...
		$this->superAdminCustomView('product_managements/add_inventory',$this->data);
	}
	...
	public function edit_inventory($organizationProductId=0)
	{
		...
		$this->superAdminCustomView('product_managements/edit_inventory',$this->data);
	}
