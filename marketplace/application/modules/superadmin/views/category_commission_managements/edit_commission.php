    	...
    	<div class="row">
        	<div class="col-md-12">
				<ul class="breadcrumbs-alt animated fadeInLeft">
					<li>
                    	<a href="<?php echo base_url().$this->session->userdata('userType').'/category_commission_management'; ?>">
							Category Commission List
                        </a>
                    </li>
                    <li>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-12 form-div padding_right_zero">
                                    	<div class="col-sm-12 text-right padding_right_zero">
                                        	<a class="btn btn-danger btn-save" href="<?php echo base_url().$this->session->userdata('userType').'/category_commission_management'; ?>">Cancel</a>
