    	...
    	<div class="row">
      		<div class="col-lg-12">
        		<ul class="breadcrumbs-alt animated fadeInLeft">
          			<li>
                    	<a href="javascript:void(0);" class="current">Spacepointe Commission2 List</a>
                    </li>
                </ul>
      		</div>
<div class="col-lg-12">
	<section class="panel">
        ...
        <div class="panel-body">
        	<section class="panel custom-panel">
			   ...
			   <div style="padding:0;" class="col-lg-12">
			   		<h5>This commission is deducted from the retailer price as quoted, this is forwarded to pointeforce team</h5>
			   </div>
			</section>
...
{
	ajaxPage('<?php echo base_url().$this->session->userdata('userType').'/category_commission_management2/ajaxFun'; ?>');
}
