...
?>                                                                                           		  
					   ...
					   <div class="details_main">
							...
							<div class="col-lg-6">
								<div class="panel-body" style="line-height:21px;">  
									...
									<div style="max-width:95%; margin:0 auto; padding-bottom:40px;">
	<h2>Roles</h2>
	...
	<div class="col-sm-6" style="margin-bottom:10px;">
		<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
			<label class="">
				<input type="checkbox" name="roles[]" id="checkbox<?php echo $i; ?>"<?php echo set_checkbox('roles[]', $row->roleId); ?> /<?php if((!empty($result['employeeRoleList'][$row->roleId]))&&($result['employeeRoleList'][$row->roleId]==$row->roleId)){ ?> checked="checked" <?php } ?> class="check1" value="<?php echo $row->roleId; ?>"/>
