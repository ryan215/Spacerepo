      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="breadcrumbs-alt animated fadeInLeft">
            ...
            <li> <a class="current" href="#">PointePay & Pointemart</a> </li>
          </ul>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          <section class="panel">
            ...
            <div class="col-sm-5" style="padding-top:8px; padding-left:0;">PointePay and Pointemart</div>
                 ...
                 <table class="table table-custom table-invoice">
                    ...
                    <tbody>
                      <tr>
						...
						<td>Demo</td>
						<td>India</td>
                        <td><a href="<?php echo base_url(); ?>admin/dashboard/test4" class="btn btn-warning btn-xs"><i class="fa fa-eye"></i></a></td>
                      </tr>
                      <tr>
                        <td>2</td>
                        <td>Business</td>
