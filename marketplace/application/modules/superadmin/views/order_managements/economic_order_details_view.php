            ...
            <td style="background:none; padding:0;">
             <table class="table table-invoice" style="margin:0; padding:0 !important; border-spacing:3px;">
        		...
        		<tr>
		          ...
		          <td>
				  	<a class="btn btn-xs color_box active_color color_static" style="margin-left: 0px; margin-right: 0px;background-color:<?php echo $row['color']; ?>" href="javascript:void(0);"/></a>
				</td>
		        </tr>
		        <?php
				}
				...
				if($row['retailerPrice'])
				{
				?>
		        <tr>
		          <td width="30%">Retailer Pay Back Price: </td>
		          <td>&#x20A6;<?php echo number_format(($row['retailerPrice']*$row['quantity']),2); ?></td>
		        </tr>
		        <?php
				}
    ...
    <table class="table table-invoice table-custom" style="">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo '&#x20A6;'.number_format($result['cashHandlingPrice'],2); ?></td>
        </tr>
        <?php
				}
				?>        
