        ...
        <div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumbs-alt animated fadeInLeft">
					<li>
						<a href="<?php echo base_url().'superadmin/retailer_management'; ?>">
							Retailer List
						</a>
					</li>
					<li>
						<a href="<?php echo base_url().'superadmin/retailer_management/user_detail/'.id_encrypt($organizationId); ?>">
							View
						</a>
					</li>
					<li>
						<a href="<?php echo base_url().'superadmin/check_stock_management/check_stock_list/'.id_encrypt($organizationId); ?>">
							Inventory
						</a>
					</li>
					<li>
                    	...
                    	<section class="panel custom-panel" style="margin-bottom:0;">
							<div style="padding:0;" class="col-lg-12">
                				<div class="col-sm-7 " style="padding: 5px;">
									<a href="<?php echo base_url().'superadmin/semantics'; ?>" class="btn btn-sm btn-shadow btn-success hvr-push" style="float:left;">
...
function ajax_search()
{
	...
	$.ajax({
		type: "POST",
		url:'<?php echo base_url().'superadmin/check_stock_management/add_check_stock_list_ajax'; ?>',
		data:'sel_no_entry='+$('#sel_no_entry').val()+'&productName='+$("#productName").val()+'&product_type='+$("#product_type").val()+'&productCategory='+$("#productCategory").val()+'&organizationId=<?php echo $organizationId; ?>&brandName='+$("#brandName").val()+'&<?php echo $this->security->get_csrf_token_name(); ?>=<?php echo $this->security->get_csrf_hash(); ?>',
		beforeSend: function() {
...
ajaxPage('<?php echo base_url().'superadmin/check_stock_management/add_check_stock_list_ajax'; ?>');
</script>
