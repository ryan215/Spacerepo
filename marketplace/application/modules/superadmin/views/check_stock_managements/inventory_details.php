        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt animated fadeInLeft">
					<li>
						<a href="<?php echo base_url().'superadmin/retailer_management'; ?>">Retailer List</a>
					</li>
					<li>
						<a href="<?php echo base_url().'superadmin/retailer_management/user_detail/'.id_encrypt($organizationId); ?>">View</a>
					</li>
					<li>
						<a href="<?php echo base_url().'superadmin/check_stock_management/check_stock_list/'.id_encrypt($organizationId); ?>">Inventory</a>
					</li>
					<li>
			...
			<?php $this->load->view('retailer/check_stock_managements/inventory_details_form'); ?>
        </div>
        <!--contant end-->
	</section>
</section>
