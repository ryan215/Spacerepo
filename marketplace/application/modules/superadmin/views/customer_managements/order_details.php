		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li>
						<a href="<?php echo base_url().$this->session->userdata('userType').'/customer_management/order_list/'.id_encrypt($customerId); ?>">
							Order List
						</a>
					</li>
					<li>
											...
											<div class="col-sm-6" style="padding-left:0px;">
												...
												<span style="font-weight:bold;font-size:14px;">
													...
													?>
														...
														<span style="font-weight:normal;">
															<?php 
															echo date("d-m-Y H:i:s",$result['confirmOrderTime']);
															?>
														</span><br />
													<?php
													}
													...
													?>
														...
														<span style="font-weight:normal;">
															<?php 
															echo date("d-m-Y H:i:s",$result['readyToShippedOrderTime']);
															?>
														</span><br />
													<?php
													}
													...
													?>
														...
														<span style="font-weight:normal;">
															<?php 
															echo date("d-m-Y H:i:s",$result['inTransitOrderTime']);
															?>
														</span><br />
													<?php
													}
													...
													?>
														...
														<span style="font-weight:normal;">
															<?php 
																echo date("d-m-Y H:i:s",$result['deliveredOrderTime']);
															?>
														</span><br />
													<?php
													}
			...
			<div class="col-sm-12 padding_zero">
				<table class="table table-invoice table-custom" style="margin-top:15px;">
					...
					<tbody>
						...
						<?php /*?><tr>
                        	<td width="35%">Zip : </td>
							<td><?php echo $result['billingZip']; ?></td>
                        </tr> <?php */?>
					</tbody>
				</table>
			</div>
