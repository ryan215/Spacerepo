        ...
        <div class="row main-rows" >
        	<div class="col-sm-12 force-form">
				...
				<center><ul class="listp">
					<li><a href="<?php echo base_url().'pointeforce'; ?>" class="activep btn btn-force-active">Join With Us</a></li>
					<li><a href="<?php echo base_url().'pointeforce/customer_request'; ?>#Alreadyacustomer" class="btn btn-force-dctive">Already a customer</a></li>
				</ul></center>
				</div>
				<div class="clearfix"></div>
				<div class="forceform-head">
				
                	<h1 style="margin-top:30px;">Join With Us</h1>
                	<p>
...
& a PointeForce Consultant will be in touch. All fields are mandatory.
	...
	<div class="forceform-contant">
                    ...
                    <div class="col-sm-12 form-group text-center">
                    	<button class="btn btn-success submit-force" name="POINTEFORCESIGNUP" value="POINTEFORCESIGNUP">
							Submit
						</button>
                    </div>
                </div>
