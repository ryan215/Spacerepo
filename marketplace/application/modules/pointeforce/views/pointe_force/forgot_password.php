    ...
    <div class="col-sm-10">
        ...
        <div class="row main-rows">
        	<div class="col-sm-8 poiteforce-intro">
				...
				<a href="#ForgotPassword" class="btn btn-danger btn-forcesignup pull-right" style="background:#F7941E; color:#fff; border:1px solid #F7941E; font-size:15px; text-transform:uppercase;   margin-top: 5px; display:inline-block;">Forgot Password</a>
...
In other words, PointeForce is where you need to belong to if you desire to be an entrepreneurial force to be reckoned with. 
        ...
        <div class="row main-rows"  id="ForgotPassword">
        ...
        <div class="row main-rows">
        	<div class="col-sm-12 force-form">
            	...
            	<div class="forceform-head">
                	...
                	<!--<p>
                    	Already a customer? Login here to send us a request for joining Pointeforce Team.
                    </p>-->
...
<div class="forceform-contant">
	...
	<div class="col-sm-12 form-group text-center" style="padding-top:0px;">
    	<button class="btn btn-success submit-force" name="pointeForceSub" value="POINTEFORCE">Send Request</button>
    </div>
</div>
</form>
...
.listp li a{ color:#979797; font-size:1.2em}
