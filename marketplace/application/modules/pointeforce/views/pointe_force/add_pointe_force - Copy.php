    ...
    <div class="col-sm-10">
        ...
        <div class="row main-rows">
        	<div class="col-sm-8 poiteforce-intro">
            	<h1><span class="poite-color" style="opacity:1;">Pointe</span> <span class="force-color" style="opacity:1;">Force</span></h1>
...
& a PointeForce Consultant will be in touch. All fields are mandatory.
	...
	<div class="forceform-contant">
                    ...
                    <div class="col-sm-12 form-group text-center">
                    	<button class="btn btn-success submit-force" name="pointeForceSub" value="POINTEFORCE">Submit</button>
                    </div>
                </div>
				</form>
            </div>
