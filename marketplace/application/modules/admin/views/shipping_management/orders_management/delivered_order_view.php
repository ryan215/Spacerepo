		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li>
						<a href="<?php echo base_url().$this->session->userdata('userType').'/delivered_order'; ?>">Delivered</a>
					</li>
					<li>
								...
								<aside class="profile-info col-lg-12" style="padding-bottom:20px;">
									<section class="panel">
                                			<div class="col-sm-12">
												...
												<div class="col-sm-2">
													<img src="<?php echo base_url(); ?>img/check.png" class="img-responsive pull-right" style="width:70%;" title="Delivered">
												</div>
											</div>
										</section>
