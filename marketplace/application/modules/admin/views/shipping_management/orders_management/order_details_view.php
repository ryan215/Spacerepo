		...
		<table class="table table-invoice table-custom" style="">
			...
			<tbody>
                ...
                <tr>
					...
					<td>
						<?php
						if((!empty($result['freeShipPrdId']))&&($result['freeShipPrdId']))
						{
							echo 'Free Shipping';
						}
						elseif((!empty($result['freeShipCatId']))&&($result['freeShipCatId']))
						{
							echo 'Free Shipping';
						}
						elseif((!empty($result['genuineShippFee']))&&($result['genuineShippFee']))
						{
