		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					<li>
						<a href="javascript:void(0);" class="current">Delivered Orders</a>
					</li>
				</ul>
			</div>
					...
					<div class="panel-body">
						<section class="panel custom-panel">
							...
							<div style="max-width:700px; margin:0 auto; padding-bottom:25px;">
								<Center>
									<img src="<?php echo base_url().'img/5.png'; ?>" class="img-responsive" style="display: inline-block;">
								</center>
							</div>
							<?php
							}
...
{
	ajaxPage('<?php echo base_url().$this->session->userdata('userType').'/delivered_order/deliveredAjaxFun/'.$result['total']; ?>');
}
