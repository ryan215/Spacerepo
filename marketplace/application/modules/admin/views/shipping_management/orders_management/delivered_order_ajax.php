...
if(!empty($result['list']))
{
	...
	<tr>
		...
		<td>
			<center><a href="<?php echo base_url().$this->session->userdata('userType').'/delivered_order/delivered_order_view/'.id_encrypt($row->orderId); ?>" class="btn btn-warning btn-xs">
				<i class="fa fa-eye"></i>
			</a></center>
		</td>
	</tr>
