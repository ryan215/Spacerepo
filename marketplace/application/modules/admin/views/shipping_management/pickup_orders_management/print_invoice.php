...
<table class="table table-invoice table-custom" style="width:100%;margin-bottom:0px !important;">
	...
	<tbody>
		<tr>
			...
			<td>&#x20A6;<?php echo number_format($result['productPrice'],2); ?>/<?php echo $result['productQuantity']; ?></td>
			<td>&#x20A6;<?php echo number_format(($result['productPrice']*$result['productQuantity']),2); ?></td>
		...
		<tr>	
			...
			<td><h2 style="margin:0px !important;">&#x20A6; <?php 
				echo number_format(($result['productPrice']*$result['productQuantity']),2); ?></h2></td>
		</tr>	
	</tbody>	
</table>
