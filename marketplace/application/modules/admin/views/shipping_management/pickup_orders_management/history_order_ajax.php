...
<tr>
    ...
    <td>
    	<center>
			<a href="<?php echo base_url().$this->session->userdata('userType').'/history_order_pickup/history_order_view/'.id_encrypt($row->orderId); ?>" class="btn btn-warning btn-xs" type="button" title="View Detail">
			<i class="fa fa-eye"></i>
		</a></center>
	</td>
