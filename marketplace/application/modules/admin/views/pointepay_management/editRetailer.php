  ...
  <section class="wrapper"> 
    ...
    <div class="col-md-12">
		<ul class="breadcrumbs-alt animated fadeInLeft">
			...
			<li>
				<a href="<?php echo base_url().$this->session->userdata('userType').'/pointepay_management/user_detail/'.id_encrypt($organizationId); ?>">
					View 
				</a> 
			</li>
        	<li>
...
<?php echo form_open();?>
    ...
    <center>
    	<div class="details_main">
            ...
            <div class="col-sm-12 ">
              <center>
                <a class="btn btn-danger btn-save" href="<?php echo base_url().$this->session->userdata('userType').'/pointepay_management/user_detail/'.id_encrypt($organizationId); ?>"> Cancel </a>&nbsp;&nbsp;
