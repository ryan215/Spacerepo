              ...
              <div class="col-lg-12" style="padding:0;">
                <div class="col-sm-12 " style="padding: 5px;">
                  ...
                  <div class="col-sm-12" style="padding-left:0px;"> 
					...
					{
					?>
					<a href="<?php echo base_url().$this->session->userdata('userType').'/pointepay_management/searchRetailer'; ?>" class="btn btn-sm btn-shadow btn-success hvr-push" style="float:left;"><i class="fa fa-plus"></i> 
							Add
						</a>
					...
					*/}																			
					?>
                    <div class="form-group" style="width:100px; float:left; margin-left:10px; margin-right:5px;">
...
function ajax_search()
{
	...
	ajaxPage('<?php echo base_url().$this->session->userdata('userType');?>/pointepay_management/ajaxRetailerList');	
}
ajax_search();
