    ...
    <div class="row">
      <div class="col-lg-12">
        <ul class="breadcrumbs-alt">
          <li> <a href="javascript:void(0);" class="current">Shipping Vendor List</a> </li>
        </ul>
      </div>
      <div class="col-lg-12">
        <section class="panel">
              ...
              <div class="col-lg-12" style="padding:0;">
                <div class="col-sm-12 " style="padding: 5px;">
                  ...
                  <div class="col-sm-12" style="padding-left:0px;"> 
				  		<a href="<?php echo base_url().$this->session->userdata('userType').'/vendor_management/addVendore'; ?>" class="btn btn-sm btn-shadow btn-success hvr-push" style="float:left;"><i class="fa fa-plus"></i> 
							Add
						</a>
              ...
              <table class="table table-invoice table-custom table-search-head" style="100%">
                <thead>
                  <tr>
					...
					<th width="17%"> Bussiness Name</th> 
                    <th width="14%"> Bussiness Phone</th>
...
{	
	$.ajax({
		type: "POST",
		url:'<?php echo base_url().$this->session->userdata('userType').'/vendor_management/ajaxFun/'; ?>',
		data:'sel_no_entry='+$('#sel_no_entry').val()+'&<?php echo $this->security->get_csrf_token_name(); ?>=<?php echo $this->security->get_csrf_hash(); ?>',
		beforeSend: function() {
...
ajaxPage('<?php echo base_url().$this->session->userdata('userType').'/vendor_management/ajaxFun/'; ?>');
