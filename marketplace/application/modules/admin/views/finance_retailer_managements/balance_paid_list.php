					...
					<div class="panel-body">							
						<div class="col-lg-12 pd">
							<ul class="wallet_tab">
								...
								<li>
									<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/processing_balance'; ?>" title="Processing">
										Processing Balance
									</a>
								</li>
								<li>
									<a href="javascript:void(0);" title="Paid" class="activetab">
										Paid Balance
									</a>
								</li>
							</ul>
										...
										<tr>
											<th colspan="5">											
												<h5 class="pull-right" style="margin:0px;">
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/balance_paid_view/'.id_encrypt($row['organizationId']); ?>" class="btn btn-medium btn-success  pull-left">
														View
													</a>
												</h5>
											</th>
									...
									<tbody>
										<tr class="first odd">								  
											...
											<td width="25%" class="padding_right_zero product_list_sec">
												...
												<td width="42%" style="" class="padding_right_zero product_user_sec">
													<table>
													<tr>
														<td class="pd" width="30%" style="padding-right:10px;">
															<h5><strong>Buisness Name : </strong></h5>
														</td>
														<td class="pd"><h5><?php echo ucwords($row['organizationName']); ?></h5></td>
													</tr>
													<tr>	
													<td class="pd"  style="padding-right:10px;vertical-align:top;"><h5><strong>Address : </strong></h5></td>
													<td class="pd" style="vertical-align:top;"><h5 style="line-height:20px;">
															<?php
												...
												<td class="a-center last product_user_sec" width="28%" style="vertical-align:top;">
													<h5 class="pull-right text-right">
														...
														<img src="<?php echo base_url(); ?>images/new_images/paid.png" width="20%" class="pull-right paid_img">
													</h5>													
													<div class="clearfix"></div>
												</td>
											</tr>
