        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					<li>
						<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/processing_balance'; ?>">
							Retailer
						</a> 
					</li>
		  			<li> 
            	...
            	<section class="panel">
					...
					<div class="row state-overview">
                          <aside class="col-lg-3">
								...
								<br /><br />
										  <a class="btn btn-warning" type="button" href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/reference_number/'.id_encrypt($organizationId).'/'.id_encrypt($result['financeRetailerIniPayId']); ?>" style="font-size: 1em;">Confirm Payment</a>   		 
                      			</section>
							</center>
							<div class="col-lg-12">
								<p>
