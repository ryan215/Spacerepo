				...
				<section class="panel">
					<div class="panel-body">							
						<div class="col-lg-12 pd">
							<ul class="wallet_tab">
								<li>
									<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management'; ?>" title="Available">
										Available Balance
									</a>
								</li>
								<li>
									<a href="javascript:void(0);" title="Processing" class="activetab">
										Processing Balance
									</a>
								</li>
								<li>
									<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/paid_balance'; ?>" title="Paid">
										Paid Balance
									</a>
								</li>
							</ul>
							...
							<div class="table-responsive">
								...
								<table class="data-table order-tables-box">
										...
										<tr>
											<th colspan="5">											
												<h5 class="pull-right" style="margin:0px;">
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/balance_processing_view/'.id_encrypt($row['organizationId']); ?>" class="btn btn-medium btn-success  pull-left">
														View
													</a>
													<?php
													if($row['totalRetailerAmount'])
													{
													?>
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/reference_number/'.id_encrypt($row['organizationId']).'/'.id_encrypt($row['financeRetailerIniPayId']); ?>" class="btn btn-medium btn-warning pull-left">
														Confirm Payment
													</a>
													<?php
													}
									...
									<tbody>
										<tr class="first odd">								  
											<td class="image padding_right_zero" width="5%">
												<a class="product-image" title="Joy Links Baby Diapers">
													<img src="<?php echo base_url(); ?>images/new_images/vendor_icon.png" style="" title="Shipping Vendors">
												</a>
											</td>
											<td width="25%" class="padding_right_zero product_list_sec">
												...
												<td width="42%" class="padding_right_zero"style="vertical-align:top;">
													<table>
													<tr>
														<td class="pd" width="25%" style="padding-right:10px;vertical-align:top;">
															<h5><strong>Buisness Name : </strong></h5>
														</td>
														<td class="pd">
															<h5><?php echo ucwords($row['organizationName']); ?></h5>
														</td>
													</tr>
													<tr>
													<td class="pd"  style="padding-right:10px;vertical-align:top;"><h5><strong>Address : </strong></h5></td>
													<td><h5 style="line-height:20px;">
															<?php
												...
												<td class="a-center last product_user_sec"  width="28%" style="vertical-align:top;">
													<h5 class="pull-right text-right">
														Retailer Available Price : 
