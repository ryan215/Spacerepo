				...
				<section class="panel">
					<div class="panel-body">							
						<div class="col-lg-12 pd">
							<ul class="wallet_tab">
								<li>
									<a href="javascript:void(0);" class="activetab" title="Available">
										Available Balance
									</a>
								</li>
								<li>
										...
										<tr>
											<th colspan="5">											
												<h5 class="pull-right" style="margin:0px;">
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/balance_available_view/'.id_encrypt($row['organizationId']); ?>" class="btn btn-medium btn-success  pull-left">
														View
													</a>
													<?php
													if($row['totalAvailableRetailerAmount'])
													{
													?>
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/initiate_payment/'.id_encrypt($row['organizationId']); ?>" class="btn btn-medium btn-warning pull-left">
														Initiate Payment
													</a>
													<?php
													}
												...
												<td width="28%" class="a-center last product_user_sec"  style="vertical-align:top;">
													<h5 class="pull-right text-right">
														...
														<span class="ava_price">
															<strong>
																<?php echo '&#x20A6;'.number_format($row['totalAvailableRetailerAmount'],2); ?>
															</strong>
														</span>
													</h5>
													<h5 class="pull-right">
														Retailer Ledger Price : 
														<span class="ava_price">
															<strong>
																<?php echo '&#x20A6;'.number_format($row['totalLedgerRetailerAmount'],2); ?>
															</strong>
														</span>
													</h5>
													<div class="clearfix"></div>
