            	...
            	<section class="panel">
					...
					<div class="row state-overview">
                          <aside class="col-lg-3">
								...
								<br /><br />
									<?php
									if($result['totalAvailableRetailerAmount'])
									{
									?>
										<a class="btn btn-warning" type="button" href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/initiate_payment/'.id_encrypt($organizationId); ?>" style="font-size: 1em;">
											Initiate Payment
										</a>   		 
									<?php
									}
...
<section class="panel">
	<div class="panel-body">							
		<div class="col-lg-12 pd">
        	<ul class="wallet_tab">
				<li>
					<a href="javascript:void(0)" class="activetab" title="Available balance">
						Available balance
					</a>
				</li>
				<li>
					<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/balance_available_ledger_view/'.id_encrypt($organizationId); ?>" title="Ledger balance">
						Ledger balance
					</a>
				</li>
			</ul>
