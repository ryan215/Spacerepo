    ...
    <div class="row">
    	<div class="col-md-12">
      		<ul class="breadcrumbs-alt animated fadeInLeft">
				...
				<li>
					<a href="<?php echo base_url().$this->session->userdata('userType').'/employee_management/user_detail/'.id_encrypt($organizationId); ?>">
						View 
					</a>
				</li>
		        <li>
        ...
        <div class="form-group">
			...
			<div class="col-sm-6" style="margin-bottom:10px;">
				<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
					<label class="">
						<input type="checkbox" value="<?php echo $dropShipRow->dropCenterId; ?>" <?php echo set_checkbox('dropshipCentre[]',$dropShipRow->dropCenterId); if(in_array($dropShipRow->dropCenterId,$dropship_center)){ echo 'checked="checked"';}?> name="dropshipCentre[]" class="check1">
            ...
            <div class="col-sm-12 ">
              <center>
                <a class="btn btn-danger btn-save" href="<?php echo base_url().$this->session->userdata('userType').'/employee_management/user_detail/'.id_encrypt($organizationId); ?>">
					Cancel
				</a>&nbsp;&nbsp;
