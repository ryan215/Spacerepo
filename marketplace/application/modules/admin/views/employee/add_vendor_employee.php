                    ...
                    <div class="form-group">
						...
						<div class="col-sm-6" style="margin-bottom:10px;">
							<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
								<label class="">
									<input type="checkbox" value="<?php echo $dropShipRow->dropCenterId; ?>" <?php echo set_checkbox('dropshipCentre[]',$dropShipRow->dropCenterId);?> name="dropshipCentre[]" class="check1">
