...
{
	ajaxPage('<?php echo base_url().$this->session->userdata('userType').'/news_subscription_email/ajax_mail_history_list'; ?>');	
}
...
.view-message{ color:#797979;}
.footer_bg{ background:#EAE0E0 !important;}
/* ------------------------------------------- 
		PHONE
