        ...
        <div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumbs-alt animated fadeInLeft">
					<li>
						<a href="<?php echo base_url().'admin/retailer_management'; ?>">
							Retailer List
						</a>
					</li>
					<li>
						<a href="<?php echo base_url().'admin/retailer_management/user_detail/'.id_encrypt($organizationId); ?>">
							View
						</a>
					</li>
					<li>
						<a href="<?php echo base_url().'admin/check_stock_management/check_stock_list/'.id_encrypt($organizationId); ?>">
							Inventory
						</a>
					</li>
					<li>
                    	...
                    	<section class="panel custom-panel" style="margin-bottom:0;">
							<div style="padding:0;" class="col-lg-12">
                				<div class="col-sm-7 " style="padding: 5px;">
									<a href="<?php echo base_url().'admin/semantics'; ?>" class="btn btn-sm btn-shadow btn-success hvr-push" style="float:left;">
...
function ajax_search()
{
	...
	$.ajax({
		type: "POST",
		url:'<?php echo base_url().'admin/check_stock_management/add_check_stock_list_ajax'; ?>',
...
ajaxPage('<?php echo base_url().'admin/check_stock_management/add_check_stock_list_ajax'; ?>');
</script>
