        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li>
						<a href="javascript:void(0);" class="current">Sub Category3 List</a>
					</li>
				</ul>
			</div>
        	<div class="col-lg-12">
...
function sub_category_form(subCat4ID)
{	
	postData = '<?php echo $sendData; ?>';
	ajax_function("<?php echo base_url(); ?>admin/sub_category3/sub_category_form/"+subCat4ID,'#addEditModal',postData);
...
function ajax_search()
{
	...
	ajax_function('<?php echo base_url(); ?>admin/sub_category3/ajaxFun/<?php echo $total; ?>/','#ajaxData',postData);
}
...
ajaxPage('<?php echo base_url(); ?>admin/sub_category3/ajaxFun/<?php echo $total; ?>/');
<?php 
...
function delete_sub_category3(subcatID)
{
	confirm_box('<?php echo base_url().'admin/sub_category3/delete_sub_category3/'; ?>'+subcatID,'Are you sure want to delete this sub category 3 ?');
}
</script>