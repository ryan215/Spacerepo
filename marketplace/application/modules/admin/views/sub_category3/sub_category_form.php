				...
				<div class="panel-body">
                	<div class="tab-content">
                    	<div class="tab-pane active" id="home">
							...
							echo form_open('',$attr);?>
							<input type="hidden" name="subCat3ID" value="<?php echo $subCat3ID; ?>" />
                        	<div class="row">
							...
							?>
								...
								<div class="col-sm-12  form-div">
									Sub Category 3 :
                                	<div class="col-sm-12">
                                    	<input type="text" class="form-control model-input" placeholder="SubCategory3 Name" name="sub_category3" id="sub_category3" value="<?php echo $sub_category3; ?>">
										<?php echo $subCat3ERR; ?>
                                    </div>
                                </div>
