                        ...
                        <section class="panel custom-panel" style="margin-bottom:0;">
                            <div class="col-lg-12" style="padding:0;">
                                <div class="col-sm-12 " style="padding: 5px;">
									...
									{
									?>
										<a href="<?php echo base_url().'admin/news_subscription/download_list_vip'; ?>" class="btn btn-success">
											Download List
										</a>
									<?php
									}
                                ...
                                <tr>
                                    <th width="1%">S.no.</th>
                                     <th>
									  ...
									  <th>
									 	Gender
										<select class="form-control search table-head-search" name="gender" id="gender" onchange="ajax_search();">
...
{
	ajaxPage('<?php echo base_url().'admin/news_subscription/ajax_subscription_list_vip'; ?>');
}
...
function ajaxPage(urlLink)
{
	...
	$.ajax({
		type: "POST",
		url:urlLink,
		data:'sel_no_entry='+$('#sel_no_entry').val()+'&gender='+$('#gender').val()+'&<?php echo $this->security->get_csrf_token_name(); ?>=<?php echo $this->security->get_csrf_hash(); ?>&email='+$('#emailId').val()+'&dateTime='+$('#dateTime').val(),
		beforeSend: function() {
...
ajaxPage('<?php echo base_url().$this->session->userdata('userType').'/news_subscription/ajax_subscription_list_vip'; ?>');
</script>