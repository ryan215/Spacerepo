					...
					<div class="panel-body">							
						<div class="col-lg-12 pd">
							<ul class="wallet_tab">
								...
								<li>
									<a href="javascript:void(0);" class="activetab" title="Paid">
										Paid Balance
									</a>
								</li>
							</ul>
										...
										<tr>
											<th colspan="5">											
												<h5 class="pull-right" style="margin:0px;">
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management/balance_paid_view/'.id_encrypt($row['shippingOrgId']); ?>" class="btn btn-medium btn-success  pull-left">
														View
													</a>
												</h5>
											</th>
									...
									<tbody>
										<tr class="first odd">								  
											<td class="image padding_right_zero" width="5%">
												<a class="product-image" title="<?php echo ucwords($row['name']); ?>">
													<img src="<?php echo base_url(); ?>images/new_images/vendor_icon.png" style="">
												</a>
											</td>
