					...
					<div class="panel-body">							
						<div class="col-lg-12 pd">
							<ul class="wallet_tab">
								...
								<li>
									<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management/processing_balance'; ?>" title="Processing">
										Processing Balance
									</a>
								</li>
								<li>
									<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management/paid_balance'; ?>" title="Paid">
										Paid Balance
									</a>
								</li>
							</ul>
										...
										<tr>
											<th colspan="5">											
												<h5 class="pull-right" style="margin:0px;">
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management/balance_available_view/'.id_encrypt($row['shippingOrgId']); ?>" class="btn btn-medium btn-success  pull-left">
														View
													</a>
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management/initiate_payment/'.id_encrypt($row['shippingOrgId']); ?>" class="btn btn-medium btn-warning pull-left">
														Initiate Payment
													</a>
												</h5>
											</th>
											...
											<td width="25%" class="padding_right_zero product_list_sec">
												...
												<td width="28%" class="a-center last product_user_sec"  style="vertical-align:top;">
													<h5 class="pull-right text-right">
														Shipping Vendor Available Price : 
														<span class="ava_price">
															<strong>
																<?php echo '&#x20A6;'.number_format($row['shippingAmt'],2); ?>
															</strong>
														</span>
													</h5>
													<div class="clearfix"></div>
