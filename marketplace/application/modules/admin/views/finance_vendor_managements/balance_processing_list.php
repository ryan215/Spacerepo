				...
				<section class="panel">
					<div class="panel-body">							
						<div class="col-lg-12 pd">
							<ul class="wallet_tab">
								<li>
									<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management'; ?>" title="Available">
										Available Balance
									</a>
								</li>
								<li>
										...
										<tr>
											<th colspan="5">											
												<h5 class="pull-right" style="margin:0px;">
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management/balance_processing_view/'.id_encrypt($row['shippingOrgId']); ?>" class="btn btn-medium btn-success  pull-left">
														View
													</a>
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management/reference_number/'.id_encrypt($row['shippingOrgId']).'/'.id_encrypt($row['financeVendorIniPayId']); ?>" class="btn btn-medium btn-warning pull-left">
														Confirm Payment
													</a>
												</h5>
											</th>
