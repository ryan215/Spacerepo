        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					<li>
						<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management'; ?>" class="">
							Shipping Vendors
						</a> 
					</li>
					<li>
                    	...
                    	<aside class="col-lg-3">
                        	<center>
								<section class="panel">
									...
									<br /><br />
									<a class="btn btn-warning" type="button" href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management/initiate_payment/'.id_encrypt($result['shippingOrgId']); ?>" style="font-size: 1em;">
										Initiate Payment
									</a>
								</section>
							</center>
...
<aside class="col-lg-3 padding_left_zero padding_right_zero">
						  ...
						  <aside class="col-lg-3 padding_left_zero padding_right_zero">
							...
							<aside class="col-lg-3 padding_left_zero">
								<section class="panel">
						        	<div class="panel-body bio-graph-info pd" style="padding-top:0px; padding-right:10px;">
										<table class="table table-invoice table-custom" style="margin-top:15px;">
						                	<thead>
						                    	<tr>
													<th colspan="2" style="background-color:#A9D86E; color:#FFF;">
