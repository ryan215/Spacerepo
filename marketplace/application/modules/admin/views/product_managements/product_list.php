                    	...
                    	<section class="panel custom-panel" style="margin-bottom:0;">
							<div style="padding:0;" class="col-lg-12">
                				<div class="col-sm-7 " style="padding: 5px;">
									...
									<a href="<?php echo base_url().'admin/product_request_management'; ?>" class="btn btn-white btn-reqt" style="position:relative; top:-3px;">
								...
								<div class="col-sm-5 pull-right">
									<a href="<?php echo base_url().'admin/product_marketing_management'; ?>" class="btn btn-white btn-reqt pull-right" style=" background-color: #fa8564; color:#fff; border:1px solid #fa8564;">
