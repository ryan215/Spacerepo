				...
				<div class="panel-body">
                	<div class="tab-content">
                    	<div class="tab-pane active" id="home">
							...
							echo form_open('',$attr);?>
							<input type="hidden" name="subCat5ID" value="<?php echo $subCat5ID; ?>" />
                        	<div class="row">
							...
							?>
								...
								<div class="col-sm-12  form-div">
									Sub Category 5 : 
                                	<div class="col-sm-12">
                                    	<input type="text" class="form-control model-input" placeholder="SubCategory5 Name" name="sub_category5" id="sub_category5" value="<?php echo $sub_category5; ?>">
                                    </div>
									<?php echo $subCat5ERR; ?>
                                </div>
