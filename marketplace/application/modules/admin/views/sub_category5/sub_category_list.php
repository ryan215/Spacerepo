        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li>
						<a href="javascript:void(0);" class="current">Sub Category5 List</a>
					</li>
				</ul>
			</div>
        	<div class="col-lg-12">
...
function sub_category_form(subCat5ID)
{	
	postData = '<?php echo $sendData; ?>';
	ajax_function("<?php echo base_url(); ?>admin/sub_category5/sub_category_form/"+subCat5ID,'#addEditModal',postData);
...
function ajax_search()
{
	...
	ajax_function('<?php echo base_url(); ?>admin/sub_category5/ajaxFun/<?php echo $total; ?>/','#ajaxData',postData);
}
...
ajaxPage('<?php echo base_url(); ?>admin/sub_category5/ajaxFun/<?php echo $total; ?>/');
...
function delete_sub_category5(subcatID)
{
	confirm_box('<?php echo base_url().'admin/sub_category5/delete_sub_category5/'; ?>'+subcatID,'Are you sure want to delete this sub category 5 ?');
}
</script>