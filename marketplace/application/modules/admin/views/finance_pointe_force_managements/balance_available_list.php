					...
					<div class="panel-body">							
						<div class="col-lg-12 pd">
							<ul class="wallet_tab">
								...
								<li>
									<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_pointe_force_management/processing_balance'; ?>" title="Processing">
										Processing Balance
									</a>
								</li>
								<li>
										...
										<tr>
											<th colspan="5">											
												<h5 class="pull-right" style="margin:0px;">
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_pointe_force_management/balance_available_view/'.id_encrypt($row['customerId']); ?>" class="btn btn-medium btn-success  pull-left">
														View
													</a>
													<?php
													if($row['totalCustomPointeForceAmount'])
													{
													?>
													<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_pointe_force_management/initiate_payment/'.id_encrypt($row['customerId']); ?>" class="btn btn-medium btn-warning pull-left">
														Initiate Payment
													</a>
													<?php
													}
