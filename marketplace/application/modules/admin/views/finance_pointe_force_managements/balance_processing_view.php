	...
	<section class="wrapper">
        ...
        <div class="row">
        	...
        	<div class="col-lg-12">
                        	...
                        	<center>
								<section class="panel">
									...
									if(!empty($result['orderList']))
									{
										...
										{
									?>
									<a class="btn btn-warning" type="button" href="<?php echo base_url().$this->session->userdata('userType').'/finance_pointe_force_management/reference_number/'.id_encrypt($result['customerId']).'/'.id_encrypt($result['financePointefIniPayId']); ?>" style="font-size: 1em;">
										Confirm Payment
									</a>
									<?php
										}
				...
				<section class="panel">
					<div class="col-sm-12 page-header  panel-heading1" style="margin-bottom:5px;">Processing Balance </div>
