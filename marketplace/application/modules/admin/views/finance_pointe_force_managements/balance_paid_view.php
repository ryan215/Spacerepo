        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					<li>
						<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_pointe_force_management/paid_balance'; ?>" class="">
							Pointe Force
						</a> 
					</li>
					<li>
        	...
        	<div class="col-lg-12">
				...
				<section class="panel" style="display:inline-block; width:100%;">
                 <div class="col-sm-12">
						  ...
						  <aside class="col-lg-6 padding_left_zero padding_right_zero">
						  	<section class="panel">
