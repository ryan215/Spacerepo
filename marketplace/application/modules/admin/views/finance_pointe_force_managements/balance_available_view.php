        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					<li>
						<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_pointe_force_management'; ?>" class="">
							Pointe Force
						</a> 
					</li>
					<li>
        	...
        	<div class="col-lg-12">
            	<section class="panel">
					...
					<div class="row state-overview">
                    	...
                    	<aside class="col-lg-3">
                        	<center>
								<section class="panel">
									...
									if(!empty($result['orderList']))
									{
										...
										{
									?>
									<a class="btn btn-warning" type="button" href="<?php echo base_url().$this->session->userdata('userType').'/finance_pointe_force_management/initiate_payment/'.id_encrypt($result['customerId']); ?>" style="font-size: 1em;">
										Initiate Payment
									</a>
									<?php
										}
						  ...
						  <aside class="col-lg-5 padding_left_zero padding_right_zero">
						  	<section class="panel">
				...
				<section class="panel">
					<div class="col-sm-12 page-header  panel-heading1" style="margin-bottom:5px;">Available Balance </div>
											...
											<th colspan="5">
												...
												<h5 class="pull-right" style="margin-right:15px; margin-top: 14px;">
													...
													<span style="color:#E96A5E;top: 1px;position: relative; font-size:18px;">
														<strong>
															+<?php echo number_format($row['totalPointeForceAmount'],2); ?>														
														</strong>
													</span>
												</h5>
											</th>
									...
									<tbody>
										...
										<tr class="first odd">								  
											...
											<td class="a-center last" style="vertical-align:top;">
												<?php
													if(!empty($productRow['totalCommissionPrice']))
													{
													?>
												     <h5 class="pull-right">Balance : 
													 	<span style="color:#ff6c60; font-size:18px;top: 1px;position: relative;">
															<strong>+<?php echo '&#x20A6;'.number_format($productRow['totalCommissionPrice'],2); ?></strong>
														</span>
													</h5>
													<?php
													}
