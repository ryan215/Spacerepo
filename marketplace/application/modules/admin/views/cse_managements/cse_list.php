        ...
        <div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumbs-alt">
					<li>
						<a href="javascript:void(0);" class="current">CSE Management</a>
					</li>
				</ul>
			</div>
        	<div class="col-lg-12">
                    	...
                    	<section class="panel custom-panel margin-btm-zero">
							...
							<div class="col-sm-5 " style="padding: 5px;">
								 <div class="col-sm-2 col-lg-2" style="padding-left:0px;">
								 	<a class="btn btn-sm btn-shadow btn-success hvr-push" type="button" href="<?php echo base_url().$this->session->userdata('userType').'/cse_management/addCse'; ?>">
...
{
	ajaxPage('<?php echo base_url().$this->session->userdata('userType').'/cse_management/ajaxFun/'.$result['total']; ?>');
}
