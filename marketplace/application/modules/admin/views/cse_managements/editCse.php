              ...
              <div class="details_main">
                ...
                <div class="col-sm-12">
                  <div class="img_box">
                    <div class="right">
                     <?php
					if((!empty($result['imageName']))&&(file_exists('uploads/cse/'.$result['imageName'])))											
					{
					?>
				...
				<div class="form-group">
					<?php
					$cse_dropship_center = array();
					if(!empty($result['cseDropshipList']))
					{
						foreach($result['cseDropshipList'] as $dropshipCentre)
						{
							$cse_dropship_center[] = $dropshipCentre->dropCenterId;
						}
					}
					...
					<div class="col-sm-6" style="margin-bottom:10px;">
						<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
							<label class="">
								<input type="checkbox" value="<?php echo $row->dropCenterId; ?>" <?php echo set_checkbox('dropshipCentre[]',$row->dropCenterId); if(in_array($row->dropCenterId,$cse_dropship_center)){ echo 'checked="checked"'; } ?>name="dropshipCentre[]" class="check1">											
