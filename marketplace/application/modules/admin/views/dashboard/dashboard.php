        ...
        <div id="owl-demo" class="owl-carousel">          
            ...
            <div class="item">
				...
				<div class="pro-imgdiv">
					...
					if((!empty($rowVal->imageName))&&(file_exists('uploads/product/thumb500_500/'.$rowVal->imageName)))
					{
						$imageUrl = base_url().'uploads/product/thumb500_500/'.$rowVal->imageName;
					}
					elseif((!empty($rowVal->imageName))&&(file_exists('uploads/product/'.$rowVal->imageName)))
					{
				...
				<p class="product_names" title="<?php echo $rowVal->code; ?>" style="height:60px;">
                	<?php
					if(strlen($rowVal->code)>10)
					{
						$productName = substr($rowVal->code,0,50).'...'; 
					}
					else
					{
				...
				<p>
				<?php /*?><div class="sale-prcdiv">&#x20A6;<?php echo number_format($displayPrice,2); ?></div><?php */?>
			</div>
			<?php		
				$i++;
				}
...
function product_add_by_cse()
{
	...
	$.ajax({
		...
		data:'stateId='+stateId+'&cseReqDay='+cseReqDay+'&<?php echo $this->security->get_csrf_token_name(); ?>=<?php echo $this->security->get_csrf_hash(); ?>',
		beforeSend: function() {
...
function product_action_by_admin()
{
	...
	$.ajax({
		...
		data:'adminActDay='+adminActDay+'&<?php echo $this->security->get_csrf_token_name(); ?>=<?php echo $this->security->get_csrf_hash(); ?>',
		beforeSend: function() {
