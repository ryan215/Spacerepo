        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li>
						<a href="javascript:void(0);" class="current">Sub Category2 List</a>
					</li>
				</ul>
			</div>
        	<div class="col-lg-12">
                        	...
                        	<div style="padding:0;" class="col-lg-12">
								...
								<div class="input-group m-bot15 " >
											  ...
											  <select class="selectpicker chosen-select form-control" data-style="btn-success" name="sorting"  id="sorting" onchange="ajax_search();">
												...
												<option value="sub_category2_name">Sub Category2 Name</option>
										</select></div>                                                 
                                              </div>
...
function sub_category_form(subCat2ID)
{	
	postData = '<?php echo $sendData; ?>';
	ajax_function("<?php echo base_url(); ?>admin/sub_category2/sub_category_form/"+subCat2ID,'#addEditModal',postData);
...
function ajax_search()
{
	...
	ajax_function('<?php echo base_url(); ?>admin/sub_category2/ajaxFun/<?php echo $total; ?>/','#ajaxData',postData);
}
...
ajaxPage('<?php echo base_url(); ?>admin/sub_category2/ajaxFun/<?php echo $total; ?>/');
...
function delete_sub_category2(subcatID)
{
	confirm_box('<?php echo base_url().'admin/sub_category2/delete_sub_category2/'; ?>'+subcatID,'Are you sure want to delete this sub category 2 ?');
}
</script>