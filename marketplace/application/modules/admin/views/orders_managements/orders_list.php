		...
		<div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					<li>
						<a href="javascript:void(0);" class="current">Orders List</a>
					</li>
				</ul>
			</div>
							...
							<table class="table table-invoice table-hover table-striped table-customm table-search-head">
								<thead>
									<tr>
										...
										{
										?>
										<input type="hidden" id="cusDetDrp" value="">
										<input type="hidden" id="cusDetTxt" value="">
										<input type="hidden" id="retDetDrp" value="">
										<input type="hidden" id="retDetTxt" value="">
										<?php
										}
										?>
...
{
	ajaxPage('<?php echo base_url().$this->session->userdata('userType').'/orders_management/orders_ajax_list'; ?>');
}
