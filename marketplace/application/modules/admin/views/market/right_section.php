        ...
        <div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumbs-alt">
					<li>
						<a href="javascript:void(0);" class="current">Right Slider List</a>
					</li>
				</ul>
			</div>
        	<div class="col-lg-12">
		...
		?>
            	<section class="panel">
                	<header class="panel-heading">
                        <a class="btn btn-primary" href="<?php echo base_url().$this->session->userdata('userType').'/marketing/addRightSlider'; ?>">
							Edit
						</a>
                      </header>
...
ajaxPage('<?php echo base_url().$this->session->userdata('userType').'/marketing/rightAjaxFun/'.$total; ?>');
</script>
