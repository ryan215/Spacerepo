...
$(document).ready(function(){
	...
	var settings = {
    url: "<?php echo base_url().$this->session->userdata('userType'); ?>/marketing/upload_image/right",
    method: "POST",
	...
	if($("#leftImage3").val()!='')
	{	
		$("#showLeftImage3").html('<img src="<?php echo base_url().'uploads/advertise/'; ?>'+$("#leftImage3").val()+'" height="100" width="100" />');			
	}
	...
	$("#leftUploadImage3").uploadFile(settings);
});
</script>
                          	  ...
                          	  <div class="form-group last">
								  ...
								  <div class="col-sm-12" style="margin-top:15px;">
                                      ...
                                      <div class="col-sm-4 col-lg-3">
                                              ...
                                              <div class="fileupload-new fileupload-new-left thumbnail" style="width: 200px; height: 150px;" id="showLeftImage3">
                                             <img src="<?php echo base_url();?>img/no_image.jpg" alt="">
                                             </div>
                                              <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
											  <?php echo form_error('left_image3'); ?>
                                              <div>
                                           </div> 
                                       </div>
                                    
                                      <div class="col-sm-3" style="padding-top:50px;">
                                        <div id="leftUploadImage3">
                                            <span class="btn btn-danger btn-file">
                                                <span class="" id="imgname">
                                                    <i class="fa fa-paper-clip"></i> Browse image
                                                </span>
                                        ...
                                        <input type="hidden" name="left_image3" value="<?php echo $result['left_image3']; ?>" id="leftImage3" />
                                       </div>
                                        </div>
                                       <div class="col-sm-3" style="padding-top:50px;">
                                       		<input class="form-control" type="text" name="urllink3" placeholder="Image Link" value="<?php echo $result['left_link3']; ?>"/>
											 <?php echo form_error('urllink3'); ?>
                                       </div>
								    </div>
