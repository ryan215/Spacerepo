        ...
        <div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumbs-alt animated fadeInLeft">
					...
					<li>
						<a href="javascript:void(0);" class="current">Campaign Management Products</a>
					</li>
				</ul>
			</div>
...
<div class="col-sm-2 col-lg-2" style="padding-left:0px;"> 
	<div class="col-sm-4 col-lg-3">
		<div class="form-group">	
        	<a href="<?php echo base_url().$this->session->userdata('userType').'/product_marketing_management/history_list'; ?>" class="btn btn-danger">
            History
            </a>
		</div>
    </div>										
...
function ajax_search()
{
	...
	ajax_function('<?php echo base_url().$this->session->userdata('userType'); ?>/product_marketing_management/prodAjaxfun','#ajaxData',postData);
}
...
ajaxPage('<?php echo base_url().$this->session->userdata('userType'); ?>/product_marketing_management/prodAjaxfun');
</script>
