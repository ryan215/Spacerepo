...
if(!empty($list))
{
	...
	foreach($list as $row)
	{
		...
		<td><a href="<?php echo base_url().$this->session->userdata('userType'); ?>/product_marketing_management/inventory_details/<?php echo id_encrypt($row->marketingProductId);?>" class="btn btn-warning btn-xs tooltips" title="View details">
				<i class="fa fa-eye"></i>
			</a></td>
		</tr>
		<?php
