        ...
        <div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumbs-alt animated fadeInLeft">
					...
					<li>
						<a href="javascript:void(0);" class="current">Flash Sales Products</a>
					</li>
				</ul>
			</div>
                    	...
                    	<section class="panel custom-panel" style="margin-bottom:0;">
							<div style="padding:0;" class="col-lg-12">
								...
								<div class="col-sm-5 col-lg-5" style="padding-left:0px;"> 
										...
										Choose One of The Retailer from the list below
									</div>
              				</div>	
                        </section>
                              <section id="unseen">
...
function ajax_search()
{
	...
	postData = 'sel_no_entry='+$('#sel_no_entry').val()+'&businessName='+$("#businessName").val()+'&state='+$("#state").val()+'&area='+$("#area").val()+'&ownerName='+$("#ownerName").val();
	ajax_function('<?php echo base_url().$this->session->userdata('userType'); ?>/product_marketing_management/ajaxProductRetailer/<?php echo id_encrypt($productId);?>','#ajaxData',postData);
}
...
ajaxPage('<?php echo base_url().$this->session->userdata('userType'); ?>/product_marketing_management/ajaxProductRetailer/<?php echo id_encrypt($productId);?>');
</script>
