        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li>
						<a href="javascript:void(0);" class="current">Sub Category4 List</a>
					</li>
				</ul>
			</div>
        	<div class="col-lg-12">
...
{	
	...
	ajax_function("<?php echo base_url(); ?>admin/sub_category4/sub_category_form/"+subCat4ID,'#addEditModal',postData);
...
function ajax_search()
{
	...
	ajax_function('<?php echo base_url(); ?>admin/sub_category4/ajaxFun/<?php echo $total; ?>/','#ajaxData',postData);
}
...
ajaxPage('<?php echo base_url(); ?>admin/sub_category4/ajaxFun/<?php echo $total; ?>/');
<?php 
...
function delete_sub_category4(subcatID)
{
	confirm_box('<?php echo base_url().'admin/sub_category4/delete_sub_category4/'; ?>'+subcatID,'Are you sure want to delete this sub category 4?');
}
</script>