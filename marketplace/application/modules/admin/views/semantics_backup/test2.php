																   ...
																   <div class="form-group">
																	  <div class="radios col-lg-12" style="padding-top:0px !important;">																		 
																		  <label class="label_radio" for="radio-01" style="display:inline-block;  margin-right: 20px;">
																			 <input type="radio"  id="radio-01" name="selectsize" value="1" onclick="hide_size()" placeholder="" <?php echo set_radio('selectsize', '1'); ?>>NO
																		  </label>
																		  <label class="label_radio" for="radio-02" style="display:inline-block;">
																			   <input type="radio"  id="radio-02" name="selectsize" onclick="show_size();" value="2" placeholder=""<?php echo set_radio('selectsize', '2', TRUE); ?> >Yes
																		  </label>                                             
																	  </div>	 
																	  <div class="col-lg-12" style="padding-bottom:10px;" id="size">
