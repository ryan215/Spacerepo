            	...
            	<div class="img_box">
                  ...
                  <div class="panel-body panel-body-customs" style="line-height:21px;">
                    ...
                    <div class="form-group">
                      <select name="dropshipCentre" class="form-control rtlr-signup-select">
									<option value="">Select Dropship Centre</option>
									<?php
									if(!empty($result['dropshipCentreList']))
									{
										foreach($result['dropshipCentreList'] as $dropShipRow)
										{
									?>
									<option value="<?php echo $dropShipRow->dropCenterId; ?>" <?php if($result['dropshipCentre']==$dropShipRow->dropCenterId){ ?> selected="selected" <?php } ?>>	
										<?php echo $dropShipRow->dropCenterName; ?>
									</option>
									<?php
										}
									}
                  ...
                  <div class="col-lg-6">
                    <div class="panel-body panel-body-customs" style="line-height:21px;">
                      ...
                      <i class="fa fa-star icon_req star-reqr"></i><strong></strong>
                      <div class="form-group">
                  ...
                  <div class="col-lg-6">
                    <div class="panel-body panel-body-customs" style="line-height:21px;">
                      ...
                      <div class="form-group">
                        <div class="iconic-input right"> 
                          <input type="text" name="email" value="<?php echo $result['email']; ?>" placeholder="email" class="form-control ship-input ship-input2">
                  ...
                  <div class="col-lg-6">
                    <div class="panel-body panel-body-customs" style="line-height:21px;">
                      <label class="signup-labels">Business Phone</label>
                      <i class="fa fa-star icon_req star-reqr"></i>
                      <div class="form-group ">
