    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="breadcrumbs-alt">
		  ...
		  <li> <a href="javascript:void(0);" class="current">Request List</a> </li>
        </ul>
      </div>
      <div class="col-lg-12">
        <section class="panel">
              ...
              <div class="col-lg-12" style="padding:0;">
                <div class="col-sm-12" style="padding: 5px;">
                 	<div class="dropdown" id="header_notification_bar">
                      <a href="<?php echo base_url().$this->session->userdata('userType').'/retailer_management/request_history_list'; ?>" class="btn btn-white btn-reqt">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="" style="padding:0px;"><span class="records_per_page">Records Per Page</span></div>
                    </div>
...
function ajax_search()
{
	...
	ajaxPage('<?php echo base_url().$this->session->userdata('userType').'/retailer_management/requestAjaxFun/'.$result['total']; ?>');	
}
ajax_search()
