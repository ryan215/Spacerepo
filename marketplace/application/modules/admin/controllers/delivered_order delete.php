...
class Delivered_order extends MY_Controller {
	...
	{	
		...
		$this->adminCustomView('shipping_management/orders_management/delivered_order_list',$this->data);
	}
	...
	public function deliveredAjaxFun($total=0)
	{
		...
		$this->load->view('shipping_management/orders_management/delivered_order_ajax',$this->data);
	}
	...
	{	
		...
		$this->adminCustomView('shipping_management/orders_management/delivered_order_view',$this->data);
	}
}