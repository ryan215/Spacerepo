...
class Marketing extends MY_Controller {
	...
	public function slider_list()
	{
		...
		$this->adminCustomView('admin/market/slider_list',$this->data);	
	}
	...
	public function addEditSliderList($slider_id='')
	{
		...
		$this->adminCustomView('admin/market/addEditSliderList',$this->data);	
	}
	...
	public function left_section()
	{
		...
		$this->adminCustomView('admin/market/left_section',$this->data);	
	}
	...
	public function addLeftSlider()
	{
		...
		$this->adminCustomView('admin/market/addLeftSlider',$this->data);	
	}
	...
	public function right_section()
	{
		...
		$this->adminCustomView('admin/market/right_section',$this->data);	
	}
	...
	public function addRightSlider()
	{
		...
		$this->data['result'] = $result;		
		$this->adminCustomView('admin/market/addRightSlider',$this->data);	
	}
