...
class Brand_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->adminCustomView('brand_managements/brand_list',$this->data);
	}
	...
	public function ajaxFun($total=0)
	{
		...
		$this->load->view('brand_managements/ajaxPagView',$this->data);
	}
	
	public function addEditBrand($brandId=0)
	{
		$this->session->set_userdata(array(
				'log_MODULE' => 'addEditBrand',
				'log_MID'    => '' 
		) );
		...
		$this->data['imageUploadPath'] = base_url().'admin/brand_management/upload_image/';
		$this->adminCustomView('brand_managements/addEditBrand',$this->data);
	}
