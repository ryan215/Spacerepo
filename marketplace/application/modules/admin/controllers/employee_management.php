...
class Employee_management extends MY_Controller {
	...
	{	
	$this->adminCustomView('employee/vendor_employee_list',$this->data);
	}
	...
	public function addVendorEmployee()
	{
		...
		$this->adminCustomView('employee/add_vendor_employee',$this->data);
	}
	public function user_detail($organizationId)
	{
		...
		$this->adminCustomView('employee/user_details',$this->data);
	}
