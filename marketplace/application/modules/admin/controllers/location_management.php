...
class Location_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->adminCustomView('location_managements/country_list_view',$this->data);
	}
	...
	public function country_ajaxFun($total=0)
	{
		...
		$pagConfig = array(
		   				'base_url'    => base_url().'admin/location_management/country_ajaxFun/'.$total.'/',
		   				'total_rows'  => $total,
			 		    'per_page'    => $per_page,
			  		    'uri_segment' => 5,
		                'num_links'   => 4
		...
		$this->data['page']  = $page;
		$this->load->view('location_managements/country_ajaxPagView',$this->data);
	}
	...
	public function addEditCountry($countryId=0)
	{
		...
		$this->adminCustomView('location_managements/addEditCountry',$this->data,true);
	}
	...
	public function state_list_view()
	{
		...
		$this->adminCustomView('location_managements/state_list_view',$this->data);
	}
	...
	public function state_ajaxFun($total=0)
	{
		...
		$this->load->view('location_managements/state_ajaxPagView',$this->data);
	}
	...
	public function addEditstate($stateId=0)
	{
		...
		if($_POST)							
		{
			...
			if($this->form_validation->run())
			{
				...
				redirect(base_url().'admin/location_management/state_list_view');
			}
		}
		...
		$this->data['result']  = $result;
		$this->adminCustomView('location_managements/addEditstate',$this->data,true);
	}
	...
	public function area_list_view()
	{
		...
		$this->adminCustomView('location_managements/area_list_view',$this->data);
	}
	...
	public function area_ajaxFun($total=0)
	{
		...
		$this->load->view('location_managements/area_ajaxPagView',$this->data);		
	}
	...
	public function zip_list_view()
	{
		...
		$this->adminCustomView('location_managements/zip_list_view',$this->data);
	}
	...
	public function zip_ajaxFun($total=0)
	{
		...
		$this->load->view('location_managements/zip_ajaxPagView',$this->data);		
	}
	...
	public function addEditZip($zipId=0)
	{
		...
		$this->adminCustomView('location_managements/addEditZip',$this->data);
	}
	...
	public function stateCountryList()
	{
		...
		$this->data['stateId'] = $stateId;
		echo $this->load->view('location_managements/stateCountryList',$this->data,true);		
	}
	...
	public function stateCountryPhoneCodeList()
	{
		...
		$this->data['stateList'] = $this->location_m->state_list('','',$where);
		$this->data['stateId'] = $stateId;
		$result['view'] = $this->load->view('location_managements/stateCountryList',$this->data,true);	
		$result['phoneCode'] = '';
	...
	public function areaStateList()
	{
		...
		echo $this->load->view('location_managements/areaStateList',$this->data,true);		
	}
	...
	public function cityAreaList()
	{
		...
		echo $this->load->view('location_managements/cityAreaList',$this->data,true);		
	}
	...
	public function cityStateList()
	{
		...
		$this->data['cityList'] = $this->location_m->zip_list('','',$where);
		$this->data['cityId']   = $cityId;
		echo $this->load->view('location_managements/cityStateList',$this->data,true);		
	}
}