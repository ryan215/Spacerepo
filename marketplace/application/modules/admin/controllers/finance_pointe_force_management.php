...
class Finance_pointe_force_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->adminCustomView('finance_pointe_force_managements/balance_available_list',$this->data);
	}
	...
	public function balance_available_view($customerId=0)
	{
		...
		if(!$customerId)
		{
			redirect(base_url().'admin/finance_pointe_force_management');
		}
		
		$this->data['result']     = $this->finance_pointe_force_lib->balance_available_view($customerId);
		$this->data['customerId'] = $customerId;
		$this->adminCustomView('finance_pointe_force_managements/balance_available_view',$this->data);
	}
	...
	public function initiate_payment($customerId=0)
	{
		...
		$this->data['customerId'] = $customerId;
		$this->adminCustomView('finance_pointe_force_managements/initiate_payment',$this->data);
	}
	...
	public function processing_balance()
	{
		...
		$this->adminCustomView('finance_pointe_force_managements/balance_processing_list',$this->data);
	}
	...
	public function balance_processing_view($customerId=0)
	{
		...
		if(!$customerId)
		{
			redirect(base_url().'admin/finance_pointe_force_management/processing_balance');
		}
		
		$this->data['result']     = $this->finance_pointe_force_lib->balance_processing_view($customerId);
		$this->data['customerId'] = $customerId;
		$this->adminCustomView('finance_pointe_force_managements/balance_processing_view',$this->data);
	}
	...
	public function reference_number($customerId=0,$financePointefIniPayId=0)
	{
		...
		$this->data['customerId'] = $customerId;
		$this->adminCustomView('finance_pointe_force_managements/reference_number',$this->data);
	}
	...
	public function paid_balance()
	{
		...
		$this->adminCustomView('finance_pointe_force_managements/balance_paid_list',$this->data);
	}
