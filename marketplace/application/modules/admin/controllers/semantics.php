...
class Semantics extends MY_Controller {
	...
	public function index()
	{
		...
		$this->adminCustomView('semantics/product_listing',$this->data);
	...
	public function ajax_product_list()
	{
		...
		$this->load->view('semantics/ajax_product_listing',$this->data);
	...
	public function add_product($time,$key)
	{
		...
		{	
			...
			redirect('admin/semantics/product_listing/'.id_encrypt($product_id));
		}
	}
	...
	public function addEditProductImage($product_id='')
	{
		...
		$this->adminCustomView('retailer/product_managements/addEditSemanticProductImage',$this->data);
	}
	...
	public function product_listing($product_id)
	{
		...
		redirect('admin/semantics/product_detail/'.id_encrypt($product_id));
		}
		}
		...
		$this->adminCustomView('semantics/test1',$this->data);
	}
	public function product_detail($product_id)
	{
		...
		{	//echo "<pre>"; print_r($_POST); exit;
			...
			if($this->form_validation->run())
			{
				...
				redirect('admin/semantics/addEditProductImage/'.id_encrypt($product_id));
		...
		$this->adminCustomView('semantics/test2',$this->data);
	}
	...
	public function deleteImage($productImageId='',$product_id='')
	{
		...
		redirect(base_url().'admin/semantics/addEditProductImage/'.$product_id);
	}
	...
	public function makeMainImage($productImageId='',$product_id='')
	{
		...
		redirect(base_url().'admin/semantics/addEditProductImage/'.id_encrypt($product_id));		
	}
	public function product_review($product_id)
	{
		...
		if($_POST)
		{
			...
			$this->session->set_flashdata('success','Successfully Added to the Product List');
		...
		//echo "<pre>"; print_r($this->data['product_data']); exit;
		$this->data['product_detail']=$this->product_m->product_attributes_details($product_id);
		$this->adminCustomView('semantics/test3',$this->data);
	}
	...
	{
		$attribute_name_id=$_POST['attribute_id'];
		$attribute_value_id=$_POST['attribute_value'];
		$this->db->delete('product_attribute_name', array('productAttributeNameId' => $id)); 
		$this->db->delete('product_attribute', array('orgProductAttributeId' => $attribute_value_id )); 
