...
class Orders_management extends MY_Controller {
	...
	{	
		...
		$this->adminCustomView('orders_managements/orders_list',$this->data);
	}
	...
	public function orders_ajax_list()
	{
		...
		$this->load->view('orders_managements/orders_ajax_list',$this->data);
	}	
	...
	public function single_shippment_order_view($orderCustomPaymentId=0)
	{
		...
		$this->adminCustomView('orders_managements/single_shippment_order_view',$this->data);
	}
	...
	public function quick_shippment_order_view($orderDetailId=0)
	{
		...
		$this->adminCustomView('orders_managements/quick_shippment_order_view',$this->data);
	}
	...
	public function quick_shippment_print_invoice()
	{
		...
		$this->data['result'] = $result;
		echo $this->load->view('orders_managements/quick_shippment_print_invoice',$this->data,true);
	}
	...
	public function quick_shippment_print_label()
	{
		...
		$result	 = $this->order_lib->quick_shippment_print_invoice($orderDetailId);
		$this->data['result'] = $result;
		echo $this->load->view('orders_managements/quick_shippment_print_label',$this->data,true);
	}
	...
	public function pickup_order_view($orderDetailId=0)
	{
		...
		$this->data['result']  		 = $result;
		$this->data['orderDetailId'] = $orderDetailId;
		$this->adminCustomView('orders_managements/pickup_order_view',$this->data);
	}
	...
	public function pickup_print_lable()
	{
		...
		$this->data['result'] = $result;
		echo $this->load->view('orders_managements/pickup_print_lable',$this->data,true);
	}
	...
	public function pickup_print_invoice()
	{
		...
		$this->data['result'] = $result;
		echo $this->load->view('orders_managements/pickup_print_invoice',$this->data,true);
	}
