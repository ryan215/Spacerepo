...
class Confirm_order extends MY_Controller {
	...
	{	
		...
		$this->adminCustomView('shipping_management/orders_management/confirm_order_list',$this->data);
	}
	...
	public function confirmationOrderAjaxFun($total=0)
	{
		...
		$this->load->view('shipping_management/orders_management/confirmation_order_ajax',$this->data);	
	}
	...
	{	
		...
		$this->adminCustomView('shipping_management/orders_management/confirm_order_view',$this->data);
	}
