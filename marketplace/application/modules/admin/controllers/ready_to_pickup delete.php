...
class Ready_to_pickup extends MY_Controller {
	...
	{	
		...
		$this->adminCustomView('shipping_management/pickup_orders_management/ready_to_be_shipped_order_list',$this->data);
	}
	...
	public function readyShippedAjaxFun($total=0)
	{
		...
		$this->load->view('shipping_management/pickup_orders_management/ready_shipped_order_ajax',$this->data);
	}
	...
	{	
		...
		redirect(base_url().'admin/order_picked_up');	
