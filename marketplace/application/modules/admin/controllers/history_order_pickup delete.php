...
class History_order_pickup extends MY_Controller {
	...
	{	
		...
		$this->adminCustomView('shipping_management/pickup_orders_management/history_order_list',$this->data);
	}
	...
	public function historyAjaxFun($total=0)
	{
		...
		$this->load->view('shipping_management/pickup_orders_management/history_order_ajax',$this->data);
	}
