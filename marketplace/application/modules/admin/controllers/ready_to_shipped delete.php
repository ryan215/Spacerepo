...
class Ready_to_shipped extends MY_Controller {
	...
	{	
		...
		$this->adminCustomView('shipping_management/orders_management/ready_to_be_shipped_order_list',$this->data);
	}
	...
	public function readyShippedAjaxFun($total=0)
	{
		...
		$this->load->view('shipping_management/orders_management/ready_shipped_order_ajax',$this->data);
	}
	...
	{	
		...
		$this->data['result']  = $result;
		$this->data['orderID'] = $orderID;
		$this->adminCustomView('shipping_management/orders_management/ready_to_shipped_order_view',$this->data);
	}
	...
	{	
		...
		redirect(base_url().'admin/shipped_in_transit');	
	...
	public function print_invoice()
	{
		...
		$this->data['result'] = $result;
		echo $this->load->view('shipping_management/orders_management/print_invoice',$this->data,true);
	}
