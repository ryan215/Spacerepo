...
class Dashboard extends MY_Controller {
	...
	public function index()
	{
		...
		//echo "<pre>"; print_r($this->data['trendingPrdList']); exit;
		$this->adminCustomView('dashboard/dashboard',$this->data);
	}
	...
	public function product_add_by_cse()
	{
		...
		if(!empty($result))
		{
			...
			foreach($result as $row)
			{
				...
				$jsonArray['result'][$i]['url']   = base_url().'admin/dashboard/cse_chart/'.id_encrypt($row->employeeId);
				$total = $total+$row->total;
				$i++;
			}
		}
	...
	//echo "<pre>"; print_r($prdWithCat); exit;		
		...
		$this->adminCustomView('dashboard/cse_graph',$this->data);
	}
	...
	{
		$result1=$this->product_m->check_organization_product_count_list('',10);
		$result2=$this->product_m->check_organization_product_count_list(6,6);
		//print_r($result);
		$this->data['trending_products']=$result1;
		$this->data['trending_products2']=$result2;
		
		
		$this->load->helper('image');
		$this->adminCustomView('dashboard/test1',$this->data);
	}
	public function test2()
	{
		$this->adminCustomView('dashboard/test2',$this->data);
	}
	public function test3()
	{
		$this->adminCustomView('dashboard/test3',$this->data);
	}
	public function test4()
	{
		$this->adminCustomView('dashboard/test4',$this->data);
	}
	public function test5()
	{
		$this->adminCustomView('dashboard/test5',$this->data);
	}
	public function test6()
	{
		$this->adminCustomView('dashboard/test6',$this->data);
	}
}