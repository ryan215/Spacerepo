...
class History_order extends MY_Controller {
	...
	{	
		...
		$this->adminCustomView('shipping_management/orders_management/history_order_list',$this->data);
	}
	...
	public function historyAjaxFun($total=0)
	{
		...
		$this->load->view('shipping_management/orders_management/history_order_ajax',$this->data);
	}
	...
	{	
		...
		$result				   = $this->order_lib->order_view($orderID,6);
		
		$this->data['result']  = $result;
		$this->data['orderID'] = $orderID;
		$this->adminCustomView('shipping_management/orders_management/history_order_view',$this->data);
	}
}