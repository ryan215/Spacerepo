...
class Pointeforce_management extends MY_Controller {
	...
	{	
		...
		$this->data['title'] = 'Pointe Force Management';
		$this->adminCustomView('superadmin/pointe_force_managements/pointeforce_list',$this->data);
	}
	...
	public function ajaxFun()
	{
		...
		$this->load->view('superadmin/pointe_force_managements/ajaxPagView',$this->data);
	}
	...
	public function user_detail($customerId)
	{
		...
		$this->adminCustomView('superadmin/pointe_force_managements/user_details',$this->data);	
	}
