...
class New_order extends MY_Controller {
	...
	{	
		...
		$this->adminCustomView('shipping_management/orders_management/new_order_before_accept',$this->data);
	}
	...
	public function new_order_ajax($total=0)
	{
		...
		$this->load->view('shipping_management/orders_management/new_order_list_ajax',$this->data);
	}	
	...
	public function new_order_view($orderID=0)
	{
		...
		$this->adminCustomView('shipping_management/orders_management/new_order_view',$this->data);
	}
