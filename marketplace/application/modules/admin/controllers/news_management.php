...
class News_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->adminCustomView('news_managements/news_letter_list',$this->data);
	}
	...
	public function ajaxFun($total=0)
	{
		...
		$this->load->view('news_managements/ajaxPagView',$this->data);
	}
	...
	public function user_detail($newsletterId)
	{
		...
		$this->adminCustomView('news_managements/user_details',$this->data);
	}
}