...
class Confirm_pickup_order extends MY_Controller {
	...
	{	
		...
		$this->adminCustomView('shipping_management/pickup_orders_management/confirm_order_list',$this->data);
	}
	...
	public function confirmationOrderAjaxFun($total=0)
	{
		...
		$this->load->view('shipping_management/pickup_orders_management/confirmation_order_ajax',$this->data);	
	}
	...
	{	
		...
		$this->adminCustomView('shipping_management/pickup_orders_management/confirm_order_view',$this->data);
	}
	...
	public function print_invoice()
	{
		...
		$result	 = $this->order_pickup_lib->pickup_order_view($orderID,2);
		$this->data['result'] = $result;
		echo $this->load->view('shipping_management/pickup_orders_management/print_invoice',$this->data,true);
	}
