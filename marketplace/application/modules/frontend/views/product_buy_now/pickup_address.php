		...
		<div class="col-main"> 
			...
			<div class="row">
						...
						<div class="col-sm-12">
						  		<div class="panel-group" id="accordion">
									<div class="panel panel-default">
										<a href="<?php echo base_url().'frontend/product_buy_now/shipping_address/'.id_encrypt($cartId); ?>">
				...
				<div class="checkout_right col-sm-4">
					...
					<div class="opc-review-actions" style="margin-bottom:20px;">
						<h5 class="grand_total">Total
							<span class="price">
						...
						{
						?>
						<a title="Place Order Now" class="button btn-placeorder" href="<?php echo base_url().'frontend/product_buy_now/order_buy_now_pickup/'.id_encrypt($cartId); ?>" style="margin-bottom:20px;">
						...
						{
						?>
						<a  title="Place Order Now" class="button btn-placeorder" onclick="select_pickup_add();" style="margin-bottom:20px;">
							<span><span style="font-size: 18px !important;">Place Order Now</span></span>
						</a>
						<?php
						}
...
function pickup_list(stateId)
{
	$.ajax({
    	type: "POST",
        url: '<?php echo base_url().'frontend/product_buy_now/pickup_list'; ?>',
        data: 'stateId='+stateId+'&cartId=<?php echo $cartId; ?>&pickupId=<?php echo $pickupId; ?>&<?php echo $this->security->get_csrf_token_name(); ?>=<?php echo $this->security->get_csrf_hash(); ?>',
