			...
			<div class="col-main col-sm-9 col-sm-push-3">
				<article class="col-main col-sm-12 product-listmain-container">
					...
					<div class="toolbar col-sm-12" style="padding-top:0px;">
						<div class="sorter">
							<div class="view-mode">
								<a href="<?php echo frontend_grid_brand_url($brandId,$brandName); ?>" title="Grid" class="button-list">
									Grid
								</a> &nbsp;&nbsp;
								<a href="<?php echo frontend_list_brand_url($brandId,$brandName); ?>" title="List" class="button-list active" style="background-color:#fe5621; color:white;" id="list">
									List
								</a> 
							</div>
						</div>
						...
						<div class="category-products col-sm-12 pd">
								<ol id="results" style="padding:0px;" class=""></ol>     
									...
									<div align="center" style="width:100%;">
										...
										<div id="loadMore" class="load_more col-sm-12" style="display:inline-block !important; cursor:pointer; padding:0px;">
										</div>
...
$(document).ready(function() {
	...
	$.ajax({
		type: "POST",
		url:'<?php echo base_url().'frontend/product/brandAjaxFunList'; ?>',
	...
	$(".load_more").click(function (e) { //user clicks on button
        ...
        {	//alert(track_click+' < '+total_pages);
			pSorting = $('#pSorting').val();
			var posdata = $("form#srchFrm").serialize()+'&<?php echo $this->security->get_csrf_token_name(); ?>=<?php echo $this->security->get_csrf_hash(); ?>&page='+track_click+'&brandId=<?php echo $brandId; ?>&pSorting='+pSorting;
			$.ajax({
				type: "POST",
				url:'<?php echo base_url().'frontend/product/brandAjaxFunList'; ?>',
				data:posdata,
