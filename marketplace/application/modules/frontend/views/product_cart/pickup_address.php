									...
									<tr class="first odd">
										...
										<td class="a-right">
											<span class="cart-price">
												<span class="price">&#8358;<?php echo number_format(($row->productAmt*$row->quantity),2); ?></span>
											</span>
										</td>
										<td class="a-center movewishlist">
											<div class="qty-div"><?php echo $row->quantity; ?></div>
										</td>
									</tr>  
									<?php
...
<?php */?>	
					<div class="opc-review-actions" style="margin-bottom:20px;">
						...
						{
						?>
    						<a title="Place Order Now" class="button btn-placeorder" href="<?php echo base_url().'frontend/product_cart/order_add_to_cart_pickup'; ?>" style="margin-bottom:20px;">
