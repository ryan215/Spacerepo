...
<?php */?>	
					<div class="opc-review-actions">
						...
						{							
							?>
							<a title="Pay on pickup" class="button btn-placeorder" href="<?php echo base_url().'frontend/checkout_cash/pay_on_pickup_add_to_cart'; ?>">
								<span><span style="font-size: 18px !important;">Pay on Pickup</span></span>
							</a>
							<br /><br />
							<a title="Pay Online" class="button btn-placeorder" href="<?php echo base_url().'frontend/product_cart/order_add_to_cart_pickup'; ?>" style="padding:15px 133px 15px 143px">
