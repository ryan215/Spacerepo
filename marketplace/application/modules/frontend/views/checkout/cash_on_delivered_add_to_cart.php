...
?>
<tr class="first odd">
	<td class="image"><a class="product-image" title="<?php echo $results->code; ?>" href="<?php echo base_url().'frontend/single/product_detail/'.id_encrypt($results->productId); ?>">
        	<?php
        ...
        <td>
        	<h2 class="product-name" style="margin-bottom:5px;"> 
            	<a href="<?php echo base_url().'frontend/single/product_detail/'.id_encrypt($results->productId); ?>">
            ...
            <span style="margin-bottom:5px;">
                      ...
                      <a class="btn  btn-xs color_box active_color color_static" style="background-color:<?php echo $results->colorCode; ?>" href="javascript:void(0);"></a> </span>
                      <?php
						}
                      ...
                      <a class="btn btn-xs size_box  active_color size_static" href="javascript:void(0);"><?php echo $results->size; ?></a> </span>
                      <?php
						}
						?>
                      
                      <span class="seller-name"> Seller: <span> <a href="javascript:void(0);"><strong> <?php echo $results->organizationName; ?> </strong></a> </span> </span></td>
                    ...
                    <td class="a-center movewishlist"><span class="cart-price"> <span class="price">₦<?php echo number_format($displayPrice*$results->quantity,2); ?></span> </span></td>
                  </tr>
                  <?php		
									}
								}
								$totalProduct  = $totalAmt+$shipping_rate;
								$handlingPrice = ($totalProduct*$this->config->item('space_point_comission'))/100; 
								$totalProduct  = $totalProduct+$handlingPrice;
								?>
                </tbody>
              </table>
            </fieldset>
