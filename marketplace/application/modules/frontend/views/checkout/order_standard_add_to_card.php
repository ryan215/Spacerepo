...
<div id="payCashBtn" style="display:inline-block;">
	...
	<div class="col-xs-12 pd">		
		<a href="javascript:void(0);" class="button btn btn-placeorder-sub" onclick="standard_cash_on_delivery();" style="line-height:51px; margin-right:0; border:0; color:#fff;">
			Cash On Delivery
		</a>
	</div>
	<div class="col-xs-12 pd">
