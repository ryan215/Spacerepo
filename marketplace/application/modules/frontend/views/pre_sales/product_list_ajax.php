	...
	<ol class="products-list col-sm-12" id="products-list">
		...
		<li class="item even">
			<div class="product-image">
				...
				{
				?>
					<div class="sale-label sale-top-left" style="font-weight:bold !important; width:90px !important; font-size:10px !important; z-index:1 !important;top: 9px;left: -22px; letter-spacing:0 !important;" onclick="pre_sale_alert();">
						Pre-Order
					</div>			
				<?php
				}
            ...
            <div class="product-shop">
				...
				<div class="col-sm-12 col-xs-12 padding_left_zero" >
				  ...
				  <h2 class="sale-price">
					...
					?>
						<strike>
							<?php echo '&#x20A6;'.number_format($row->displayPrice,2); ?>
						</strike>
					<?php
					}
					?>
				  ...
				  <h2 class="price_list_view">
				  	<?php
											...
											{
												echo '&#x20A6;'.number_format($row->displayPrice,2);
											}
											?>
				</h2> </span> </div><div class="clearfix"></div>
				  <?php
...
#products-list .button.btn-show-more {
    height: inherit;
