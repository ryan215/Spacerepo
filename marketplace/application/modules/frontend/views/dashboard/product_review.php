					...
					<div class="dashboard">             
						<div class=" col-md-12  col-lg-12 col-sm-12 col-xs-12  my_account_right_section " style="padding-bottom: 54px !important;">
							...
							<ul id="tabs" class="nav nav-tabs custom-navtabs" data-tabs="tabs">
								...
								<li>
									<a href="<?php echo base_url().'frontend/dashboard/seller_review'; ?>">
										Seller Reviews
									</a>
								</li>        
							</ul>
										...
										<div class="col-sm-6 no-padding ">
											<div class="item-div">							
												...
												<span style="font-size:11px;">
													...
													{
														echo date('Y-m-d',strtotime('+ '.$row->estimate_time.' days'));
													}
													else
													{
										...
										<div class="col-sm-12" style="padding-top:10px;">
											...
											<div class="col-sm-12 no-padding" style="padding-top: 20px !important;text-align: right;">
												<span style="text-align:right;">
													...
													{
													?>
													<a href="<?php echo base_url().'frontend/dashboard/edit_product_review/'.id_encrypt($row->rating_id); ?>" class="review_edit">
														Edit
													</a>&nbsp;&nbsp;&nbsp;&nbsp;
													...
													{
													?>
													<a href="<?php echo base_url().'frontend/product/rating_review/'.id_encrypt($row->order_product_id); ?>" class="review_delete">
														Add
													</a>
													<?php
													}
...
function delete_review(ratingID)
{
	...
	{
		window.location.href = '<?php echo base_url().'frontend/dashboard/delete_review/'; ?>'+ratingID;
	}
	return false;
}
</script>