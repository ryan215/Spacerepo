...
class Delivered_order extends MY_Controller {
	...
	{	
		...
		$this->shippingVendorCustomView('admin/shipping_management/orders_management/delivered_order_list',$this->data);
	}
	...
	{	
		...
		$this->shippingVendorCustomView('admin/shipping_management/orders_management/delivered_order_view',$this->data);
	}
}