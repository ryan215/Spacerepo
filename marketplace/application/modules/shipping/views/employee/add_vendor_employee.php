                    ...
                    <div class="form-group">
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
													<input type="checkbox" value="1" <?php echo set_checkbox('dropshipCentre[]',1);?> name="dropshipCentre[]" class="check1">
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
														<input type="checkbox" value="2" <?php echo set_checkbox('dropshipCentre[]',2);?> name="dropshipCentre[]" class="check1">
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
														<input type="checkbox" value="3" <?php echo set_checkbox('dropshipCentre[]',3);?> name="dropshipCentre[]" class="check1">
												 <span class="fa fa-check">
												 </span>
												IKEJA1
												</label>
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
													<input type="checkbox" value="4" <?php echo set_checkbox('dropshipCentre[]',4);?> name="dropshipCentre[]" class="check1">
												 <span class="fa fa-check">
												 </span>
												OJUELEGBA1
												</label>
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
													<input type="checkbox" value="5" <?php echo set_checkbox('dropshipCentre[]',5);?> name="dropshipCentre[]" class="check1">
												 <span class="fa fa-check">
												 </span>
												OREGUN
												</label>
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
													<input type="checkbox" value="6" <?php echo set_checkbox('dropshipCentre[]',6);?> name="dropshipCentre[]" class="check1">
												 <span class="fa fa-check">
												 </span>
												ADESUWA1
												</label>
                    ...
                    <div class="col-lg-6">
                      <div class="panel-body panel-body-customs" style="line-height:21px;">
						...
						<div class="form-group ">
									...
									<input type="tel" name="countryCode" id="mobile-number" placeholder="Enter Phone Number" class="ship-input ship-input2 form-control" data-live-search="true" value="<?php echo $result['countryCode']; ?>" style="width:30%; float:left; border-top-right-radius:0; border-bottom-right-radius:0;">
