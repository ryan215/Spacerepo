  ...
  <section class="wrapper"> 
    ...
    <div class="col-md-12">
      <ul class="breadcrumbs-alt animated fadeInLeft">
        <li> <a href="<?php echo base_url().$this->session->userdata('userType').'/vendor_management'; ?>">
		Vendore List </a> </li>
		<li>
            ...
            <center>
              <div class="details_main">
                ...
                <div class="col-sm-12">
                  ...
                  <div class="col-lg-12">
                  <div class="panel-body panel-body-customs" style="line-height:21px;">
                    <label class="signup-labels">Dropship Centre</label>
                    <i class="fa fa-star icon_req star-reqr"></i>
                    <div class="form-group">
												<?php 
												$dropship_center=array();
														if(isset($result['dropshipCentre']) && (!empty($result['dropshipCentre'])))
														{
															
															foreach($result['dropshipCentre'] as $dropshipCentre)
															{
																$dropship_center[]=$dropshipCentre->dropCenterId;
															}
														}
														?>
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
													<input type="checkbox" value="1" <?php echo set_checkbox('dropshipCentre[]',1); if(in_array(1,$dropship_center)){ echo 'checked="checked"';}?> name="dropshipCentre[]" class="check1">
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
														<input type="checkbox" value="2" <?php echo set_checkbox('dropshipCentre[]',2); if(in_array(2,$dropship_center)){ echo 'checked="checked"';}?> name="dropshipCentre[]" class="check1">
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
														<input type="checkbox" value="3" <?php echo set_checkbox('dropshipCentre[]',3); if(in_array(3,$dropship_center)){ echo 'checked="checked"';}?> name="dropshipCentre[]" class="check1">
												 <span class="fa fa-check">
												 </span>
												IKEJA1
												</label>
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
													<input type="checkbox" value="4" <?php echo set_checkbox('dropshipCentre[]',4); if(in_array(4,$dropship_center)){ echo 'checked="checked"';} ?> name="dropshipCentre[]" class="check1">
												 <span class="fa fa-check">
												 </span>
												OJUELEGBA1
												</label>
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
													<input type="checkbox" value="5" <?php echo set_checkbox('dropshipCentre[]',5); if(in_array(5,$dropship_center)){ echo 'checked="checked"';}  ?> name="dropshipCentre[]" class="check1">
												 <span class="fa fa-check">
												 </span>
												OREGUN
												</label>
									...
									<div class="col-sm-6" style="margin-bottom:10px;">
										<div class="checkbox c-checkbox pull-left" style="padding-bottom:10px;">
												<label class="">
													<input type="checkbox" value="6" <?php echo set_checkbox('dropshipCentre[]',6); if(in_array(6,$dropship_center)){ echo 'checked="checked"';} ?> name="dropshipCentre[]" class="check1">
												 <span class="fa fa-check">
												 </span>
												ADESUWA1
												</label>
							  ...
							  <?php echo form_error('dropshipCentre[]'); ?></div>
                  </div>
                </div> 
