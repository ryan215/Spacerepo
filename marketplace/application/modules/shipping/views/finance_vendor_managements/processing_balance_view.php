        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li>
						<a href="javascript:void(0);" class="current">Processing balance</a>
					</li>
				</ul>
			</div>
				...
				<section class="panel">
					<div class="panel-body">							
						<div class="col-lg-12 pd">
                        	<ul class="wallet_tab">
								<li>
									<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_vendor_management'; ?>" title="Available balance">
										Available balance
									</a>
								</li>
								<li>
