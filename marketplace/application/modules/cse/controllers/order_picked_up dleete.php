...
class Order_picked_up extends MY_Controller {
	...
	{	
		...
		$this->cseCustomView('admin/shipping_management/pickup_orders_management/delivered_order_list',$this->data);
	}
	...
	public function deliveredAjaxFun($total=0)
	{
		...
		$this->load->view('admin/shipping_management/pickup_orders_management/delivered_order_ajax',$this->data);
	}
	...
	{	
		...
		$this->cseCustomView('admin/shipping_management/pickup_orders_management/delivered_order_view',$this->data);
	}
}