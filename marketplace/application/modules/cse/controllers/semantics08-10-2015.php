					...
					if($this->form_validation->run())
					{
						...
						if($organizationProductId)
						{
							...
							if(!empty($productSizes))
							{
								...
								{
									$organizationStockId = $this->product_m->add_organization_size_stock($organizationProductId,1000000000,$sizeRow->productSizeId);
									$this->custom_log->write_log('custom_log','organization size stock id is '.$organizationStockId);
									$organizationSizeIdArray[$organizationStockId] = $organizationStockId;
								}
							}
							...
							if((!empty($organizationColorIdArray))&&(!empty($organizationSizeIdArray)))
							{
								foreach($organizationColorIdArray as $colorId)
								{
									...
									{
										$organizationColorSizeId = $this->product_m->add_organization_color_size_stock($organizationProductId,$colorId,$sizeId);
							...
							elseif(!empty($organizationColorIdArray))
							{
								foreach($organizationColorIdArray as $colorId)
								{
									$organizationColorSizeId = $this->product_m->add_organization_color_size_stock($organizationProductId,$colorId,0);
									$this->custom_log->write_log('custom_log','organization color size stock id is '.$organizationColorSizeId);
								}
							}
							elseif(!empty($organizationSizeIdArray))
							{
								foreach($organizationSizeIdArray as $sizeId)
								{
									$organizationColorSizeId = $this->product_m->add_organization_color_size_stock($organizationProductId,0,$sizeId);
									$this->custom_log->write_log('custom_log','organization color size stock id is '.$organizationColorSizeId);
								}
							}
						}
