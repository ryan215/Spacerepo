...
class Orders_management extends MY_Controller {
	...
	{	
		...
		$this->cseCustomView('admin/orders_managements/orders_list',$this->data);
	}
	...
	public function single_shippment_order_view($orderCustomPaymentId=0)
	{
		...
		$this->cseCustomView('admin/orders_managements/single_shippment_order_view',$this->data);
	}
	...
	public function quick_shippment_order_view($orderDetailId=0)
	{
		...
		$this->cseCustomView('admin/orders_managements/quick_shippment_order_view',$this->data);
	}
	...
	public function pickup_order_view($orderDetailId=0)
	{
		...
		$this->data['result']  		 = $result;
		$this->data['orderDetailId'] = $orderDetailId;
		$this->cseCustomView('admin/orders_managements/pickup_order_view',$this->data);
	}
