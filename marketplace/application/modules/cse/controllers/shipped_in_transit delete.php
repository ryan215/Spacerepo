...
class Shipped_in_transit extends MY_Controller {
	...
	{	
		...
		$this->cseCustomView('admin/shipping_management/orders_management/shipped_in_transit_order_list',$this->data);
	}
	...
	{	
		...
		$this->cseCustomView('admin/shipping_management/orders_management/shipped_in_transit_order_view',$this->data);
	}
