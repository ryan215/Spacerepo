...
class Order_management extends MY_Controller {
	...
	{	
		...
		$this->cseCustomView('superadmin/order_managements/orders_list',$this->data);
	}
	...
	public function order_view($orderId=0)
	{
		...
		$this->cseCustomView('order_managements/order_view',$this->data);
	}
		...
		public function economic_order_view($orderId=0)
	{
		...
		$this->data['result']  = $result;
		$this->data['orderId'] = $orderId;
		$this->cseCustomView('order_managements/economic_order_view',$this->data);
	}
