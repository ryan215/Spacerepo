...
class Employee_management extends MY_Controller {
	...
	{	
		$this->cseCustomView('admin/employee/vendor_employee_list',$this->data);
	}
	...
	public function vendor_employee_ajax_fun()
	{
		...
		$this->load->view('admin/employee/vendor_employee_ajaxfun',$this->data);
	}
	public function addVendorEmployee()
	{
		...
		$this->cseCustomView('admin/employee/add_vendor_employee',$this->data);
	}
	public function user_detail($organizationId)
	{
		...
		$this->cseCustomView('admin/employee/user_details',$this->data);
	}
	public function editVendor($organizationId=0)
	{
		...
		$this->cseCustomView('admin/employee/editVendoremployee',$this->data);		
	}
