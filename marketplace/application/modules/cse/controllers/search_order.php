...
class Search_order extends MY_Controller {
	...
	{	
		...
		$this->cseCustomView('admin/shipping_management/orders_management/search_order_list',$this->data);
	}
	...
	public function search_order_view($orderID=0)
	{
		...
		$this->cseCustomView('admin/shipping_management/orders_management/search_order_view',$this->data);
	}
}