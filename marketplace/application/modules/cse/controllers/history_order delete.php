...
class History_order extends MY_Controller {
	...
	{	
		...
		$this->cseCustomView('admin/shipping_management/orders_management/history_order_list',$this->data);
	}
	...
	{	
		...
		$this->cseCustomView('admin/shipping_management/orders_management/history_order_view',$this->data);
	}
}