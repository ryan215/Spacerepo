...
<section id="main-content">
	<section class="wrapper">
    	...
    	<div class="row">
        	<div class="col-md-12">
				<ul class="breadcrumbs-alt animated fadeInLeft">
					<li>
						<a href="<?php echo base_url().$this->session->userdata('userType').'/product_management/inventory_details/'.id_encrypt($organizationProductId); ?>">
							Inventory Details
						</a>
					</li>
                    <li>
		...
		<?php $this->load->view('retailer/product_managements/edit_inventory_form'); ?>
	</section>
</section>
