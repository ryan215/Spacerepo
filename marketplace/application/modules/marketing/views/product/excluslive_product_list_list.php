			...
			<div class="col-main col-sm-9 col-sm-push-3">
				<article class="col-main col-sm-12 product-listmain-container">					
					<div class="toolbar col-sm-12" style="padding-top:0px;">
						<div class="sorter">
							<div class="view-mode">
								<a href="<?php echo base_url().'marketing/exclusives/product_list_grid'; ?>" title="Grid" class="button-list">
									Grid
								</a> &nbsp;&nbsp;
								<a href="<?php echo base_url().'marketing/exclusives/product_list_list'; ?>" title="List" class="button-list active" style="background-color:#fe5621; color:white;" id="list">
									List
								</a>
							</div>
						</div>
...
$(document).ready(function() {
	...
	$.ajax({
		type: "POST",
		url:'<?php echo base_url().'marketing/exclusives/ajaxFunList'; ?>',
