	...
	<div class="container main-contant-wrapper shadow-main-div">
  		<div class="row">
			<div class="yt-breadcrumbs">
    			...
    			<ul><li class="home" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a itemprop="url" href="<?php echo base_url(); ?>" title="Go to Home Page"><span itemprop="title">Home</span></a></li><li class="category4" itemscope="" itemtype=""><strong><?php echo $catName; ?></strong></li></ul>
					</div>
        			</div>
        		</div>
        	</div>
			...
			<div class="col-main col-sm-9 col-sm-push-3">
				<article class="col-main col-sm-12 product-listmain-container">					
					<div class="toolbar col-sm-12" style="padding-top:0px;">
						<div class="sorter">
							<div class="view-mode">
								<a href="<?php echo base_url().'marketing/exclusives/product_list_grid'; ?>" title="Grid" class="button-list active" style="background-color:#fe5621; color:white;" id="grid">
									Grid
								</a> &nbsp;&nbsp;
								<a href="<?php echo base_url().'marketing/exclusives/product_list_list'; ?>" title="List" class="button-list">
									List
								</a>
							</div>
						</div>
						...
						<div class="category-products col-sm-12 pd">
                            	<ol  id="results" style="padding:0px;" class=""></ol>
									...
									<div align="center" style="width:97.2%;">
										...
										<div id="loadMore" class="load_more col-sm-12" style="display: inline-block !important; cursor:pointer;">
										</div>
						...
						<div id="" class="super-category-block first-load sn-category-block">
                                        <div class="block-title-defaults ">
                                            <div class="tab-category-title block-title">
                                                <strong><span style="font-size:14px !Important"><?php echo $catName; ?></span></strong>
...
$(document).ready(function() {
	...
	$.ajax({
		type: "POST",
		url:'<?php echo base_url().'marketing/exclusives/ajaxFunGrid'; ?>',
		data:'page='+track_click+'&catList=<?php echo json_encode($catArr); ?>&pSorting='+pSorting+'&<?php echo $this->security->get_csrf_token_name(); ?>=<?php echo $this->security->get_csrf_hash(); ?>',
		dataType: 'json',
		beforeSend: function() {
	...
	$(".load_more").click(function (e) { //user clicks on button
        ...
        {	//alert(track_click+' < '+total_pages);
			pSorting = $('#pSorting').val();
			posdata = $("form#srchFrm").serialize()+'&<?php echo $this->security->get_csrf_token_name(); ?>=<?php echo $this->security->get_csrf_hash(); ?>&page='+track_click+'&catList=<?php echo json_encode($catArr); ?>&pSorting='+pSorting;
			$.ajax({
				type: "POST",
				url:'<?php echo base_url().'marketing/exclusives/ajaxFunGrid'; ?>',
				data:posdata,
...
function brandSearchFun(brndNm)
{
	...
	$.ajax({
		type: "POST",
		url:'<?php echo base_url().'marketing/exclusives/search_brand_list'; ?>',
		data:posdata,
		beforeSend: function() {
