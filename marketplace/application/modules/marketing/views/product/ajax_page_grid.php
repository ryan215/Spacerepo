	...
	<ul class="pdt-list products-grid zoomOut play">
		...
		<li class="item item-animate last">
        	...
        	<div class="item-inner">
			 <div class="sale-label sale-top-left" style="font-weight: bold !important; width: 90px !important;  font-size: 11px !important;
    top: 11px;  left: -22px; z-index: 1 !important;">VIP Sale</div>
                        	...
                        	<div class="item-price">
                          		<div class="price-box">
									<span class="regular-price">
                                        <span class="price" style="color:red !Important;"><strike>&#x20A6;<?php echo number_format($row['currentPrice'],2); ?></strike></span> 
									</span> 
								</div>
                        	</div>
                            <div class="item-price">
