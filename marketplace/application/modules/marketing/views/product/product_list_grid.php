			...
			<div class="col-main col-sm-9 col-sm-push-3">
				<article class="col-main col-sm-12 product-listmain-container">					
					<div class="toolbar col-sm-12" style="padding-top:0px;">
						<div class="sorter">
							<div class="view-mode">
								<a href="<?php echo base_url().'marketing/product/product_list_grid'; ?>" title="Grid" class="button-list active" style="background-color:#fe5621; color:white;" id="grid">
									Grid
								</a> &nbsp;&nbsp;
								<a href="<?php echo base_url().'marketing/product/product_list_list'; ?>" title="List" class="button-list">
									List
								</a> 
							</div>
						</div>
...
<script>
  jQuery(document).ready(function() {
	...
	jQuery("#div1").html($("#div1").html()+' '+nice.version);
...
$(document).ready(function() {
	...
	$.ajax({
		type: "POST",
		url:'<?php echo base_url().'marketing/product/ajaxFunGrid'; ?>',
	...
	$(".load_more").click(function (e) { //user clicks on button
        ...
        {	//alert(track_click+' < '+total_pages);
			pSorting = $('#pSorting').val();
			posdata = $("form#srchFrm").serialize()+'&page='+track_click+'&pSorting='+pSorting;
			$.ajax({
				type: "POST",
				url:'<?php echo base_url().'marketing/product/ajaxFunGrid'; ?>',
