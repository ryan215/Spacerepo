...
if(!empty($product))
{
 ...
 ?> 
	<tr>
		...
		<td><?php echo ucwords($row->modified_by); ?></td>
		<td>
			<a href="<?php echo base_url(); ?>retailer/product_management/view/<?php echo id_encrypt($row->product_id); ?>" class="btn btn-success btn-sm">
				View
			</a>
		</td>
	</tr>
