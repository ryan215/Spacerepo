...
?>
							...
							<div class="panel-body" >   
								...
								<div class="panel-body" style="line-height:21px;">                               
									<div class="form-group text-left">
                                    <label for="email" class="">Salary/month</label><span class="error">*</span>
									<div class="iconic-input right">
										
										<input type="text" id="email" placeholder="Salary/month" name="salary" class="form-control" value="<?php echo $result['salary'];?>">
										</div>
									...
									<div class="iconic-input right">
										...
										<div class="col-lg-6">
											<div class="panel-body" style="line-height:21px;">                               
												<div class="form-group text-left">
													<?php
													if(!empty($result['employeeRoleList']))
													{
														foreach($result['employeeRoleList'] as $row)
														{
													?>
													<div class="iconic-input right">
														<?php echo $row->Description; ?>
														<input type="checkbox" name="role[<?php echo $row->roleId; ?>]" value="<?php echo $row->roleId; ?>" <?php if(in_array($row->roleId,$result['role'])){ ?> checked="checked" <?php } ?> />
													</div>
													<?php
														}
													}
