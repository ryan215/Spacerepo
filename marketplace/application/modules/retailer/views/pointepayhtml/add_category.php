...
<section class="wrapper">
	...
	<div class="col-md-12">
		<ul class="breadcrumbs-alt animated fadeInLeft">
			...
			<li class="">
				<a href="<?php echo base_url(); ?>retailer/dashboard/pointepay_html/category_list" class="">Category Management</a>
			</li>
			<li class="">
...
echo form_open(base_url().'superadmin/staff_management/upload_admin_image/',$attributes);
?>
							...
							<div class="col-lg-12 pd">
								...
								<div class="panel-body" style="line-height:21px;">                               
									<div class="form-group text-left">
										<label for="CategoryName" class="">Category Name</label> <span class="error">*</span>
										<div class="iconic-input right">
												<input id="CategoryName" placeholder="Category Name" name="CategoryName" class="form-control" value="" type="text"> 
										</div>
									</div>
								</div>	
								</div>
