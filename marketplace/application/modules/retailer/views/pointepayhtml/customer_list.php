                    	...
                    	<section class="panel custom-panel">
							<div style="padding:0;" class="col-sm-12">
                            	<div class="col-sm-5 " style="padding: 5px;">
								 <div class="col-sm-2 col-lg-2" style="padding-left:0px;"><a href="<?php echo base_url(); ?>retailer/dashboard/pointepay_html/add_customer" class="btn btn-sm btn-shadow btn-success hvr-push"  >
                        ...
                        <section id="unseen">
                             <table class="table table-invoice table-custom">
							    ...
							    <tbody>
									...
									<td class="numeric">+234-8794511321</td>
									<td><center><a href="<?php echo base_url(); ?>retailer/dashboard/pointepay_html/customer_details" class="btn btn-warning btn-xs tooltips" type="button" title="View Details"><i class="fa fa-eye"></i></a></center></td>										
									</tr>
									<tr>
									<td>1</td>
									<td>
