    	...
    	<div class="row">
      		<div class="col-lg-12">
        		<ul class="breadcrumbs-alt animated fadeInLeft">
          			                     <li> <a href="javascript:void(0);" class="current">Subcategory List</a> </li>
            	...
            	<div style="padding:0;" class="col-lg-12">
                	<div class="col-sm-6 " style="padding: 5px;">
                  		<div class="col-sm-2 col-lg-2 " style="padding-left:0px;">
                        	<a type="button" class="btn btn-sm btn-shadow btn-success hvr-push" href="<?php echo base_url(); ?>retailer/dashboard/pointepay_html/add_subcategory">
            ...
            <section id="unseen" class="table-responsive">
              <table class="table table-invoice  table-hover table-striped table-custom table-search-head">
				...
				<tr>
					...
					<td>
						<a class="btn btn-primary btn-xs tooltips" data-toggle="tooltip" data-placement="top" data-original-title="Edit" type="button" href="<?php echo base_url(); ?>retailer/dashboard/pointepay_html/add_subcategory"><i class="fa fa-pencil"></i>
						</a>&nbsp;&nbsp;
						
						<a class="btn btn-warning btn-xs tooltips" data-toggle="tooltip" data-placement="top" data-original-title="View" type="button" href="<?php echo base_url(); ?>retailer/dashboard/pointepay_html/subcategory_view">
							<i class="fa fa-eye"></i>
						</a>
					</td>
				</tr>
