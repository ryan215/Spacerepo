        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt animated fadeInLeft">
					<li><a href="<?php echo base_url(); ?>retailer/dashboard/pointepay_html/category_list">Subcategory List</a></li>
                    <li><a href="javascript:void(0);" class="current">Subcategory view</a></li>
				</ul>
			</div>
        	<div class="col-lg-12">
            	<section class="panel">
                	<div class="col-sm-12 panel-heading panel-heading1">Subcategory Details</div>
					<div class="row">							
						        	...
						        	<div class="panel-body bio-graph-info" style="padding-top:0px;">
										<table class="table table-invoice table-custom">
											...
											<tbody>
													...
													<tr>
						                        	<td width="35%">Subcategory Name : </td>
						                            <td></td>
                        						</tr>
                        						<tr>
