	...
	<section class="wrapper">
		<div class="col-md-12" style="padding-left:0px;">
			<ul class="breadcrumbs-alt">
				<li>
					<a href="javascript:void(0);" class="current">My Inventory</a>
				</li>
			</ul>
		</div>
...
function subcat6_list(subCat5Id)
{
	...
	ajax_function('<?php echo base_url(); ?>retailer/myinventory/ajaxFun/<?php echo $total; ?>','#ajaxData',postData);
}
seg_list();
...
{
	postData = $("form#srchFrm").serialize();
	ajax_function('<?php echo base_url(); ?>retailer/myinventory/ajaxFun/<?php echo $total; ?>','#ajaxData','search='+srchval);
}
...
ajaxPage('<?php echo base_url(); ?>retailer/myinventory/ajaxFun/<?php echo $total; ?>');
</script>
