                      ...
                      <section class="panel">
						  ...
						  <div class="col-lg-12 pd">
                                  <section class="panel">
                                   ...
                                   <div class= "log-in-box  main-shi-div  verify-maindiv" style="max-width:500px; margin:0 auto;">
									<?php 
...
?>
                                        ...
                                        <p class="not-alrdy verify-text">We have sent a temporary verification<br> code on your phone.</p>                                   
                                        <div class="form-group">
                                            <div class="col-sm-12 addon-md" style="text-align:center;">
                                                ...
                                                <div class="col-sm-12 fivedigit-inputs">
                                                    <input type="text" class="form-control ship-input verify-input" name="otp[]" value="" maxlength="1">
                                                    <input type="text" class="form-control ship-input verify-input" name="otp[]" value="" maxlength="1">
                                                    <input type="text" class="form-control ship-input verify-input" name="otp[]" value="" maxlength="1">
                                                    <input type="text" class="form-control ship-input verify-input" name="otp[]" value="" maxlength="1"> 
                                                    <input type="text" class="form-control ship-input verify-input" name="otp[]" value="" maxlength="1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="not-alrdy" style="text-align:left;">                                               
                                                <button class="btn btn-success pull-right" type="submit" style="border-radius:5px !important;  margin-left:8px !important;">Verify</button>
                                                <a class="btn btn-default pull-right" style="border-radius:5px !important;" href="http://192.168.1.5/marketplace/retailer/home/index">
                                                    Cancel
                                                </a>
                                            </div>
                                        </div>
