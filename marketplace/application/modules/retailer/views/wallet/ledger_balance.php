        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li>
						<a href="javascript:void(0);" class="current">Current balance</a>
					</li>
				</ul>
			</div>
					...
					<div class="panel-body">							
						<div class="col-lg-12 pd">
                        	<ul class="wallet_tab">
								...
								<li><a href="javascript:void(0)" class="activetab"  title="Current balance">Current balance</a></li>
							...
							<div class="clearfix"></div><br />
								<div class="table-responsive">
									<table class="data-table order-tables-box">
										<thead>
											<tr><th colspan="5"><a class="btn btn-medium btn-processing pull-left" style="cursor:inherit;">OD1000002279</a><span class="pull-left" style="margin-top: 15px;right: 0px; position: relative;font-weight: normal;">Date: <strong>2015-09-30 15:12:53(WAT)</strong></span><h5 class="pull-right" style="margin-right:15px; margin-top: 14px;">Total Current balance : <span style="color:#E96A5E;top: 1px;position: relative; font-size:18px;"><strong>+ &#8358;750</strong></span></h5></th></tr>
										</thead>
										<tbody>
												<tr class="first odd">								  
												...
												<td width="25%" style="vertical-align:top;">
													<h5>Status : <strong>New Order</strong></h5>
												</td>
												<td>
									...
									<table class="data-table order-tables-box">
										<thead>
											<tr><th colspan="5"><a class="btn btn-medium btn-processing pull-left" style="cursor:inherit;">OD1000002279</a><span class="pull-left" style="margin-top: 15px;right: 0px; position: relative;font-weight: normal;">Date: <strong>2015-09-30 15:12:53(WAT)</strong></span><h5 class="pull-right" style="margin-right:15px; margin-top: 14px;">Total Current balance : <span style="color:#E96A5E;top: 1px;position: relative; font-size:18px;"><strong>+ &#8358;500</strong></span></h5></th></tr>
										</thead>
										<tbody>
												<tr class="first odd">								  
												<td class="image" width="10%"><a class="product-image" title="Joy Links Baby Diapers"><img src="<?php echo base_url(); ?>img/no_image.jpg" height="70" width="70"></a></td>
									...
									<table class="data-table order-tables-box">
										<thead>
											<tr><th colspan="5"><a class="btn btn-medium btn-processing pull-left" style="cursor:inherit;">OD1000002279</a><span class="pull-left" style="margin-top: 15px;right: 0px; position: relative;font-weight: normal;">Date: <strong>2015-09-30 15:12:53(WAT)</strong></span><h5 class="pull-right" style="margin-right:15px; margin-top: 14px;">Total Current balance : <span style="color:#E96A5E;top: 1px;position: relative; font-size:18px;"><strong>+ &#8358;250</strong></span></h5></th></tr>
										</thead>
										<tbody>
												<tr class="first odd">								  
												<td class="image" width="10%"><a class="product-image" title="Joy Links Baby Diapers"><img src="<?php echo base_url(); ?>img/no_image.jpg" height="70" width="70"></a></td>
												...
												<td width="25%" style="vertical-align:top;">
													<h5>Status : <strong>Confirm Order</strong></h5>
												</td>
												<td>
...
.btn-processing:hover{ color:#fff;}
</style>