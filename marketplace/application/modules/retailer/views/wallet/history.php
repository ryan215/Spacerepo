        ...
        <div class="row">
			<div class="col-md-12">
				<ul class="breadcrumbs-alt">
					...
					<li>
						<a href="javascript:void(0);" class="current">All</a>
					</li>
				</ul>
			</div>
            	...
            	<section class="panel">
					<div class="panel-body">							
						<div class="col-lg-12 pd">
                        	<ul class="wallet_tab">
								<li><a href="javascript:void(0)" class="activetab" title="All">&nbsp;&nbsp;All&nbsp;&nbsp;</a></li>
									...
									<table class="data-table order-tables-box">
										...
										<tbody>
												...
												<td width="38%"  style="vertical-align:top;">
													  ...
													  <img src="<?php echo base_url(); ?>images/new_images/paid.png" width="10%" class="pull-left" style="margin-top:8px; margin-left:5px;"  />
