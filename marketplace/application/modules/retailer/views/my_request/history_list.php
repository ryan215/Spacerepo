	...
	<section class="wrapper">
		<div class="col-md-12" style="padding-left:0px;">
				<ul class="breadcrumbs-alt">
						...
						<li>
							<a href="javascript:void(0);" class="current">Request History</a>
						</li>
				</ul>
			</div>
...
function subcat6_list(subCat5Id)
{
	...
	ajax_function('<?php echo base_url(); ?>retailer/my_request/my_history_ajax/<?php echo $total; ?>/','#ajaxData',postData);
}
seg_list();
...
ajaxPage('<?php echo base_url(); ?>retailer/my_request/my_history_ajax/<?php echo $total; ?>/');
</script>
