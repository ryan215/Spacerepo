    ...
    <div class="row">
    	<div class="col-md-12">
            <ul class="breadcrumbs-alt">
                ...
                <li>
                    <a class="current" href="javascript:void(0);">New Order</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <section id="unseen">
            	<div class="tabs-content">
                    <div class="tabs-menu clearfix">
                      <ul>
                        <li>
							<a class="active-tab-menu" href="<?php echo base_url().'retailer/new_order'; ?>">
								New Order
							</a>
						</li>
                        <li>
							<a href="<?php echo base_url().'retailer/new_order/history_order'; ?>">
								History
							</a>
						</li>
                      </ul>
...
ajaxPage('<?php echo base_url().'retailer/new_order/new_order_ajax/'.$total; ?>');
</script>
