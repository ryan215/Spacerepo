		...
		<td width="33%" style="padding:0px !important;border: 1px solid #000"> 
			...
			<td width="33%" style="padding:0px !important;  border-bottom: 1px solid #000;border-top: 0px solid #000;"> 
				...
				<td colspan="2" style="border: 0px solid #000;">
					<table width="100%">
					<tr>
                    	<td width="40%" style="color:#000; font-family: Verdana, Geneva, sans-serif; padding:6px 0 4px 6px; font-size:12px;">Pickup Center </td>
                        <td width="2%"> : </td>
                    	<td width="58%" style="padding:6px 0 4px 6px; font-size:12px;font-family: Verdana, Geneva, sans-serif;"><?php echo $result['pickupName']; ?></td>
                    </tr>
                    <tr>
                    	<td style="color:#000; font-family: Verdana, Geneva, sans-serif; padding:6px 0 4px 6px; font-size:12px;">Phone No.</td>
                        <td>:</td>
                        <td style="padding:6px 0 4px 6px; font-size:12px; font-family: Verdana, Geneva, sans-serif;"><?php echo $result['pickupPhone']; ?></td>
                    </tr><tr><td style="color:#000; padding:6px 0 4px 6px; font-size:12px;font-family: Verdana, Geneva, sans-serif;">Address</td><td>:</td><td style="padding:6px 0 4px 6px; font-size:12px;">
					<?php echo $result['pickupAddressLine']; ?></td></tr>
					</table>
				</td>
			...
			<td width="33%" style="padding:0px !important;  border-left: 1px solid #000; border-bottom: 0px solid #000;border-top: 0px solid #000;"> 
				...
				<tr><td colspan="3" style="border-bottom:1px solid #000; padding-top:15px;  padding-bottom:18px;"><center><h4 style="line-height:28px; font-family: Verdana, Geneva, sans-serif; color:#000; padding-left:6px;">Customer Details</h4></center></td></tr>
				<tr><td width="40%" style="color:#000; font-family: Verdana, Geneva, sans-serif;   padding: 6px 0 4px 6px;font-size:12px;">Name</td><td width="2%"> :</td><td width="68%" style="font-size:12px; font-family: Verdana, Geneva, sans-serif;  padding: 6px 0 4px 6px;"><?php 
					echo $result['customerFirstName'].' '.$result['customerLastName']; 
					?></td></tr>
				<tr><td style="color:#000; padding:6px 0 4px 6px; font-size:12px;font-family: Verdana, Geneva, sans-serif;">Phone No.</td><td>:</td><td  style="font-size:12px;  padding: 6px 0 4px 6px;"><?php echo $result['customerPhone']; ?></td></tr>
				</table>
			</td>
		</tr>
	</tbody>
