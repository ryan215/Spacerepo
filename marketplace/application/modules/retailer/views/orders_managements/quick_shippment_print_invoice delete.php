...
<table class="table table-invoice table-custom" style="width:100%;margin-bottom:0px !important;">
	...
	<tbody>
		<tr>
			...
			<td>&#x20A6;<?php echo number_format(($result['totalProductAmount']),2); 
			$totalAmt = $result['totalProductAmount'];
			?></td>
		...
		<tr>
			...
			<td>Shipping</td>
			<td><?php
				echo '&#x20A6;'.number_format(($result['totalCustomShippingAmount']),2);
				$shippingR = $result['totalCustomShippingAmount']; 
		...
		<tr>
			...
			<td>
				<?php
				echo '&#x20A6;'.number_format($result['totalCustomCashHandlingAmount'],2);
				$cashHandFee = $result['totalCustomCashHandlingAmount'];	
				?>
			</td>
		</tr>
        <?php
