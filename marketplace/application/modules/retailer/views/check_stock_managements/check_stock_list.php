        	...
        	<div class="col-lg-12">
            	...
            	<section class="panel">
					<div class="col-sm-12 panel-heading panel-heading1">
						<a href="<?php echo base_url().'retailer/check_stock_management/add_check_stock_list/'.id_encrypt($organizationId); ?>" class="btn btn-sm btn-shadow btn-success hvr-push"><i class="fa fa-plus"></i>
							Add Product
						</a> 
						<select class="form-control pull-left"  name='sel_no_entry' onchange="ajaxPage('<?php echo base_url().'retailer/check_stock_management/ajaxFun'; ?>');"  id='sel_no_entry' style="width:75px !important;display: inline-block;">
							...
							<table class="table table-invoice table-hover table-striped table-customm table-search-head">
								<thead>
									<tr>
										...
										<th width="20%">
											Product Name
											<input type="text" class="form-control search table-head-search" id="productName" onkeyup="ajaxPage('<?php echo base_url().'retailer/check_stock_management/ajaxFun'; ?>');" placeholder="Product Name">
										</th>
...
ajaxPage('<?php echo base_url().'retailer/check_stock_management/ajaxFun'; ?>');
</script>