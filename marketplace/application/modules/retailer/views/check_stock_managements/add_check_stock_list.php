                    	...
                    	<section class="panel custom-panel" style="margin-bottom:0;">
							<div style="padding:0;" class="col-lg-12">
                				<div class="col-sm-7 " style="padding: 5px;">
									<a href="<?php echo base_url().'retailer/semantics'; ?>" class="btn btn-sm btn-shadow btn-success hvr-push" style="float:left;">
...
function ajax_search()
{
	...
	$.ajax({
		type: "POST",
		url:'<?php echo base_url().'retailer/check_stock_management/add_check_stock_list_ajax'; ?>',
...
ajaxPage('<?php echo base_url().'retailer/check_stock_management/add_check_stock_list_ajax'; ?>');
</script>
