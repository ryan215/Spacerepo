        ...
        <div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumbs-alt animated fadeInLeft">
					<li>
						<a href="javascript:void(0);" class="current">Spacepointe List</a>
					</li>
				</ul>
			</div>
							...
							<div style="padding:0;" class="col-lg-12">
                				<div class="col-sm-12 " style="padding: 5px;">
									<div class="col-sm-3 col-lg-3" style="padding-left:0px;"> 
										...
										<a href="<?php echo base_url().$this->session->userdata('userType').'/retailer_product_management/main_product_list'; ?>" class="btn btn-sm btn-shadow btn-success hvr-push" style="float:left;">
