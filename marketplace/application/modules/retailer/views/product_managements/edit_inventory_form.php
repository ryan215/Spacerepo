				...
				<div class="panel-body">
                	<div class="col-sm-12" style="padding-top:20px;">
                        ...
                        <div class="col-sm-8">
							...
							{
							?>
							<input type="hidden" class="form-control" value="<?php echo $result['spacePointeCommission2']; ?>" name="spacePointeCommission2" id="spacePointeCommission2" readonly>
							<input type="hidden" class="form-control" value="<?php echo $result['cashAdminPrice']; ?>" name="cashAdminPrice" id="cashAdminPrice" readonly>
							<?php
							}
							else
							{
