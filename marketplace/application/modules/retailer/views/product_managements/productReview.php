<section id="main-content">
	<section class="wrapper">
		...
		<div class="col-sm-12 save-div">
			...
			{
			?>
			<a class="btn btn-success btn-save" href="<?php echo base_url().'retailer/inventory'; ?>">
				Save & Countinue
			</a>
			<?php
			}
			...
			{
			?>
			<a class="btn btn-success btn-save" href="<?php echo base_url().$this->session->userdata('userType').'/product_management/'; ?>">
				Save & Countinue
			</a>
			<?php
			}
