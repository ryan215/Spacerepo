        ...
        <div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumbs-alt animated fadeInLeft">
					<li>
						<a href="<?php echo base_url().$this->session->userdata('userType').'/retailer_product_management'; ?>">Spacepointe List</a>
					</li>
					<li>
						<a href="javascript:void(0);" class="current">Main Product List</a>
					</li>
				</ul>
			</div>
...
function ajax_search()
{
	...
	postData = 'sel_no_entry='+$('#sel_no_entry').val()+'&productName='+$("#productName").val()+'&productCategory='+$("#productCategory").val()+'&organizationId=<?php echo $organizationId; ?>&brandName='+$("#brandName").val();
	ajax_function('<?php echo base_url().$this->session->userdata('userType'); ?>/retailer_product_management/mainProductAjaxFun/<?php echo $result['total']; ?>','#ajaxData',postData);
}
...
ajaxPage('<?php echo base_url().$this->session->userdata('userType'); ?>/retailer_product_management/mainProductAjaxFun/<?php echo $result['total']; ?>');
</script>
