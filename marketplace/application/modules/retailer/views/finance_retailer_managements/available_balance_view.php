										...
										<tbody>
											...
											?>
												...
												<td class="a-center last" style="vertical-align:top;">
												     <h5 class="pull-right">Retailer Payback Price : <span style="top: 1px;position: relative;"><strong>+<?php echo '&#x20A6;'.number_format($productRow['totalRetailAmount'],2); ?></strong></span></h5><div class="clearfix"></div>
