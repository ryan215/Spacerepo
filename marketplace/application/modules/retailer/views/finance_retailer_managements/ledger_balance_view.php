					...
					<div class="panel-body">							
						<div class="col-lg-12 pd">
                        	<ul class="wallet_tab">
								...
								<li>
									<a href="javascript:void(0);" class="activetab" title="Current balance">
										Current balance
									</a>
								</li>
								<li>
									<a href="<?php echo base_url().$this->session->userdata('userType').'/finance_retailer_management/balance_paid_view'; ?>" title="Paid balance">Paid balance</a>
								</li>
							</ul>
								...
								?>
									<table class="data-table order-tables-box">
										<thead>
											<tr>
												<th colspan="5">
													<a class="btn btn-medium btn-processing pull-left" style="cursor:inherit;">
										...
										<tbody>
											...
											<tr class="first odd">								  
												...
												<td class="a-center last" style="vertical-align:top;">
													<h5 class="pull-right">
														Retailer Payback Price : <span style="top: 1px;position: relative;">
															<strong>+<?php echo '&#x20A6;'.number_format($productRow['totalRetailAmount'],2); ?></strong>
														</span>
													</h5>
													<div class="clearfix"></div>
												</td>
