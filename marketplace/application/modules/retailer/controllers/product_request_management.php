...
class Product_request_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->retailerCustomView('cse/product_managements/product_request_list',$this->data);
	}
	...
	public function view($productId='')
	{
		...
		$this->retailerCustomView('cse/product_managements/product_view',$this->data);
	}
	...
	{
		$this->retailerCustomView('product_managements/test',$this->data);
	}
}
