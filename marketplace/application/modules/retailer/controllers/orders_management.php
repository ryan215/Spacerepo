...
class Orders_management extends MY_Controller {
	...
	{	
		...
		$this->retailerCustomView('admin/orders_managements/orders_list',$this->data);
	}
	...
	public function single_shippment_order_view($orderCustomPaymentId=0)
	{
		...
		$this->data['result']				= $this->order_lib->single_shippment_order_view($orderCustomPaymentId);
		$this->data['orderCustomPaymentId'] = $orderCustomPaymentId;
		$this->retailerCustomView('orders_managements/single_shippment_order_view',$this->data);
	}
	...
	public function single_shippment_cancel_order($orderCustomPaymentId=0)
	{
		...
		{
			$this->order_lib->single_shippment_declined_order($orderCustomPaymentId);
		}
	}
	
	//	order change from confirm to ready order 1 => 2
	public function single_shippment_change_new_to_confirm_order($orderCustomPaymentId=0)
	{	
		$this->session->set_userdata(array(
		...
		if($orderCustomPaymentId)
		{
			$this->order_lib->single_shippment_change_new_to_confirm_order($orderCustomPaymentId);
		}	
	...
	public function quick_shippment_order_view($orderDetailId=0)
	{
		...
		$this->retailerCustomView('admin/orders_managements/quick_shippment_order_view',$this->data);
	}
	...
	public function pickup_order_view($orderDetailId=0)
	{
		...
		$this->data['result']  		 = $result;
		$this->data['orderDetailId'] = $orderDetailId;
		$this->retailerCustomView('admin/orders_managements/pickup_order_view',$this->data);
	}
