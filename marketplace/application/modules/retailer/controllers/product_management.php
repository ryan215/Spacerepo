...
class Product_management extends MY_Controller {
	...
	public function index()
	{
		...
		$this->retailerCustomView('product_managements/retailer_main_product_list',$this->data);
	}
	...
	public function addEditProduct($product_id='')
	{
		...
		$this->retailerCustomView('product_managements/add_edit_product',$this->data);
	}
	...
	public function addEditProductImage($product_id='')
	{
		...
		$this->retailerCustomView('retailer/product_managements/addEditProductImage',$this->data);
	}
	...
	public function makeMainImage($productImageId='',$product_id='')
	{
		...
		redirect(base_url().'retailer/product_management/addEditProductImage/'.id_encrypt($product_id));		
	}
	...
	public function addEditProductAttribute($product_id='')
	{
		...
		$this->retailerCustomView('retailer/product_managements/addEditProductAttribute',$this->data);
	}
	...
	public function productReview($product_id='')
	{
		...
		//echo "<pre>"; print_r($result); exit;
		$this->data['product_id'] = $product_id;
		$this->retailerCustomView('retailer/product_managements/adminProductReview',$this->data);
	}
	...
	public function view($product_id='')
	{
		...
		$this->data['result']     = $result;
		$this->data['product_id'] = $product_id;
		$this->retailerCustomView('product_managements/product_view',$this->data);
	}	
	...
	public function add_inventory($organizationId=0,$productId=0)
	{
		...
		$this->retailerCustomView('product_managements/add_inventory',$this->data);
	}
	...
	public function edit_inventory($organizationProductId=0)
	{
		...
		//echo "<pre>"; print_r($this->data['result']); exit;
		$this->retailerCustomView('product_managements/edit_inventory',$this->data);
	}
	...
	public function check_stocks()
	{
		...
		$this->data['organizationId'] = $organizationId;
		//echo "<pre>"; print_r($this->data['result']); exit;
		$this->retailerCustomView('product_managements/check_stocks',$this->data);
	}
	...
	public function check_stocksAjaxFun($total=0)
	{
		...
		$this->load->view('product_managements/check_stocksAjaxFun',$this->data);
	}
	...
	public function inventory_details($organizationProductId=0,$organizationId=0)
	{
		...
		$this->data['organizationProductId'] = $organizationProductId;
		$this->retailerCustomView('product_managements/inventory_details',$this->data);
	}
