...
class Check_stock_management extends MY_Controller {
	...
	public function check_stock_list($organizationId=0)
	{
		...
		$this->retailerCustomView('check_stock_managements/check_stock_list',$this->data);
	}
	...
	public function ajaxFun($total=0)
	{
		...
		$this->load->view('check_stock_managements/check_stock_list_ajax',$this->data);
	}
	...
	public function add_check_stock_list($organizationId=0)
	{
		...
		$organizationId = $this->session->userdata('organizationId');
		$this->data['organizationId'] = $organizationId;		
		$this->retailerCustomView('check_stock_managements/add_check_stock_list',$this->data);
	}
	...
	public function product_view($product_id='',$organizationId='')
	{
		...
		$this->retailerCustomView('check_stock_managements/product_view',$this->data);
	}
	...
	public function inventory_details($organizationProductId=0,$organizationId=0)
	{
		...
		$this->data['organizationId']        = $organizationId;
		$this->retailerCustomView('check_stock_managements/inventory_details',$this->data);
	}
	...
	public function add_inventory($organizationId=0,$productId=0)
	{
		...
		$this->retailerCustomView('check_stock_managements/add_inventory',$this->data);
	}
}