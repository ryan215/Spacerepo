        ...
        <table width="100%">
          <tr>
            <td><h4 style="font-size:16px; font-weight:500;">Hi {sellerName},</h4>
              ...
              <p>
              This is to notify you that an order for following item/s has been placed: please confirm the order in the panel.
              </p>
              <p>Go to this url for confirmation: <?php echo base_url().'retailer'; ?></p></tr>
        </table>
