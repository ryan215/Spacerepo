    ...
    <td class="container" bgcolor="#FFFFFF"><div class="content" >
        <table width="100%">
          <tr>
            <td><h4 style="font-size:16px; font-weight:500;">Hi {shippingVendor},</h4>
              ...
              <p>
              This is to notify you that Package #  {tracking_no} has been collected and is in transit to {custoemerCity}. Please confirm when delivered.
             </p>
        ...
        <table width="100%">
          <tr>
            ...
            <p>Should you have complaints or issues concerning the order, please contact our <br />customer service team within 24hrs by email at <strong>care@pointemart.com</strong> or by phone at <strong>016311305</strong> & <strong>016311306</strong> from 8am to 10pm on weekdays and 9am to 6pm on weekdays.</p>
