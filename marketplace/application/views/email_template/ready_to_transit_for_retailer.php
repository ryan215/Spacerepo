			...
			<table width="100%">
				<tr>
					<td>
						...
						<p>
							The order (<span> {orderId}</span>)  has been processed and shipped by our logistics team and its on delivery to the customer.							
						</p>				
						
							<p>
							
								Our retail sales representative will update you on the status of the order prior delivery within 24hrs.
								</p>
				...
				<tr>
					<td>
						<div class="" style="background:#f3f3f3; padding:12px; text-align:center;">
                        	<p>
                            For any enquiry, please contact our retail sales team at <strong>care@pointemart.com</strong> or call us at <strong>016311305</strong> & <strong>016311306</strong> between 8am and 10pm on weekdays and 9am to 6pm on weekends.
							 </p>
                        </div>
					</td>
				</tr>
