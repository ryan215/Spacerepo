        ...
        <table width="100%">
          <tr>
            <td><h4 style="font-size:16px; font-weight:500;">Hi {customerName},</h4>
              ...
              <p>This is to notify you that your order (<span>{orderId}</span>)  has been shipped and is in transit to your address. </p>
              <!--<p> Your order (<span> {orderId}</span>) has been Placed and is on the way to you. </p>-->
              <p style="padding: 8px;  background-color: rgba(117,178,82,0.2);  margin-bottom: 15px;  text-align: center;  font-size: 13px;"> 
You will receive your shipment by {eta} Days</p></td>
          </tr>
        </table>
        <table width="100%">
          <tr>
            <td><div class="" style="background:#f3f3f3; padding:12px; text-align:center;">
            <p>Should you have complaints or issues concerning the order, please contact our <br />customer service team within 24hrs by email at <strong>care@pointemart.com</strong> or by phone at <strong>016311305/6</strong> from 8am to 10pm on weekdays and 9am to 6pm on weekdays.</p>
              </div></td>
          </tr>
        </table>
        <table width="100%">
          <tr>
            <td><div class="" style="">
                <p> <span style="font-size:13px;">The following item(s) are now in transit:</span> </p>
