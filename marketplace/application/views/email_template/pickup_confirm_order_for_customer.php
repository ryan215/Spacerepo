        ...
        <table width="100%">
          <tr>
            <td><h4 style="font-size:16px; font-weight:500;">Hi {customerName},</h4>
              ...
              <p>This is to notify you that your order (<span> {orderId}</span>) has been confirmed.</p>
              <p style="padding: 8px;  background-color: rgba(117,178,82,0.2);  margin-bottom: 15px;  text-align: center;  font-size: 13px;">The order will be at {pickupCenter} in {eta} </p></td>
          </tr>
        </table>
        <table width="100%">
          <tr>
