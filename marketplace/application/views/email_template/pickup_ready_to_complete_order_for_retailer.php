    ...
    <td class="container" bgcolor="#FFFFFF"><div class="content" >
        <table width="100%">
          <tr>
            <td><h4 style="font-size:16px; font-weight:500;">Hi {sellerName},</h4>
              ...
              <p>
              We are pleased to inform you that the following item(s), order # {orderId} has been picked up by the customer. 
             </p>
        ...
        <table width="100%">
          <tr>
            ...
            <p>Should you have complaints or issues concerning the order, please contact our<br /> customer service team within 24hrs by email at <strong>care@pointemart.com</strong> or by phone at <strong>016311305</strong> & <strong>016311306</strong> from 8am to 10pm on weekdays and 9am to 6pm on weekends.</p>
