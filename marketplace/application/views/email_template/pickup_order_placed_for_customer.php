    ...
    <td class="header container" ><div class="content" style="background-color:#fff;  border-bottom:4px solid #8CB94D;">
        <table bgcolor="" class="" width="100%">
          <tr>
           ...
           <?php /*?> <td style="background-color:#fff; font-size:11px; width:85px; text-align:center;" class="logo-right-section">
    ...
    <td class="container" bgcolor="#FFFFFF"><div class="content" >
        <table width="100%">
          <tr>
            <td><h4 style="font-size:16px; font-weight:500;">Hi {customerName},</h4>
              ...
              <p>This is to notify you that your order <span> {orderId}</span>) has been placed. The order will be at {pickupCenter} in  {eta} Days</p>
        ...
        <?php /*?><table width="100%">
          <tr>
            ...
            <p>Should you have complaints or issues concerning the order, please contact our<br /> customer service team within 24hrs by email at <strong>care@pointemart.com</strong> or by phone<br /> at 01263344 from 8am to 10pm on weekdays and 9am to 6pm on weekdays.</p>
