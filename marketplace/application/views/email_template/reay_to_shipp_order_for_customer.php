  ...
  <tr>
    ...
    <td class="container" bgcolor="#FFFFFF"><div class="content" >
        <table width="100%">
          <tr>
            <td><h4 style="font-size:16px; font-weight:500;">Hi {customerName},</h4>
              <p>Greetings from SpacePointe!</p>
              <p>This is to notify you that your order (<span> {orderId}</span>) has been packaged and is ready to be shipped.</p>
              <p style="padding: 8px;  background-color: rgba(117,178,82,0.2);  margin-bottom: 15px;  text-align: center;  font-size: 13px;"> You will receive your shipment by {eta} Days</p></td>
          </tr>
        </table>
        <table width="100%">
          <tr>
        ...
        <table width="100%">
          <tr>
            <td><div class="" style="">
                <p> <span style="font-size:13px;"> The following item(s) havebeen confirmed and packaged: </span> </p>
