        ...
        <table width="100%">
          <tr>
            <td><h4 style="font-size:16px; font-weight:500;">Hi (insert winner’s name),</h4>
              ...
              <p>This is to notify you that processing of your reward/winning has been placed.
You will receive your prize in the coming days.</p>
        ...
        <table width="100%">
          <tr>
            ...
            <p>Should you have complaints or issues concerning the order, please contact our
