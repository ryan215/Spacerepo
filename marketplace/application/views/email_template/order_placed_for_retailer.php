    ...
    <td class="container" bgcolor="#FFFFFF"><div class="content" >
        <table width="100%">
          <tr>
            <td><h4 style="font-size:16px; font-weight:500;">Hi {sellerName},</h4>
             	<p>
                This is to notify you that an order for the following item/s has been placed; please confirm the order in the panel.
                </p>
                <p>Go to this URL for confirmation: <?php echo $this->config->item('retailer_url'); ?></p>
        ...
        <table width="100%">
          <tr>
            ...
            <p>Should you have complaints or issues concerning the order, please contact our<br /> customer service team within 24hrs by email at <b>care@pointemart.com</b> or by phone at <strong>016311305</strong> & <strong>016311306</strong> from 8am to 10pm on weekdays and 9am to 6pm on weekends.</p>
