...
<section id="container" class="">
    ...
    <header class="header white-bg">
        ...
        <!--logo start-->
        <a href="<?php echo $this->session->userdata('firstTimeAdminRed'); ?>" class="logo">
			<img width="200px" src="<?php echo base_url(); ?>img/slogo.png" alt="avatar" style="width: 200px; height: 55px;">
		</a>
        <!--logo end-->
