	...
	<div id="sidebar"  class="nav-collapse ">
        ...
        <div style="height:600px;overflow-y:scroll;overflow-x:hidden;">	
        	...
        	<li>
            	...
            	<a <?php if($uriSeg2=='staff_management'){ ?> class="active" <?php } ?> href="<?php echo base_url(); ?>superadmin/staff_management/">
...
<?php */?>				
			...
			<li class="sub" style="padding-bottom:80px;">
				<a href="javascript:void(0);" <?php if(($uriSeg2=='orders_management')||($uriSeg2=='vendor_management')||($uriSeg2=='search_order')){ ?> class="dcjq-parent active" <?php } ?>>
					<i class="fa fa-truck"></i>
					<span>Shipping Management</span>
				</a>
				<ul class="sub" style="height:450px;">
					<li>
						<a <?php if($uriSeg2=='orders_management'){ ?> class="sun-menu-active" <?php } ?> href="<?php echo base_url().'superadmin/orders_management'; ?>">
							<i class="fa fa-truck"></i>
