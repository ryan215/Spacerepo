...
{	
 ...
 $(document).keydown(function(e){
    if (e.keyCode == 38) { 
        ...
        $("#autoSearchRes  li").removeClass("selected");
												...
												<div class="sm-searbox-content">
													...
													<div class="form-search">
														<div class="input-search"> 
															<input type="text" class="typeahead tt-query search-text" name="all_search" id="search" onKeyUp="return not_submit(event,this.value);" onBlur="return not_submit(event,this.value);" onKeyPress="return not_submit(event,this.value);" onFocus="return not_submit(event,this.value);" autocomplete="off">
														</div>
