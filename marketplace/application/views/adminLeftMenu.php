...
<aside>
	<div id="sidebar"  class="nav-collapse " >
		...
		<div style="height:600px;overflow-y:scroll;overflow-x:hidden;">	
			...
			<li class="sub-menu">
            		<a href="<?php echo base_url(); ?>admin/marketing/slider_list" <?php if(($uriSeg2=='news_subscription_email')||($uriSeg2=='news_subscription')||($uriSeg2=='vip_listing')){ ?> class="dcjq-parent active" <?php } ?>>
			...
			<ul class="sub">
						...
						<li>
							...
							<ul class="sub">
							<li>
								<a href="<?php echo base_url();?>admin/pointepay_management/productsList">
									Products 
								</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>admin/pointepay_management/orderList">
									Order List
								</a>
							</li>
							</ul>
						...
						<li>
							<a href="<?php echo base_url();?>admin/pointepay_management/invoiceListing">
								Invoice
							</a>
						</li>
			</ul>				
