												...
												<div class="sm-searbox-content">
													...
													<div class="form-search">
														<div class="input-search"> 
															<input type="text" class="typeahead tt-query search-text" autocomplete="off" spellcheck="false"  maxlength="70" name="all_search" id="search" onKeyUp="return not_submit(event,this.value);" onBlur="return not_submit(event,this.value);">
														</div>
