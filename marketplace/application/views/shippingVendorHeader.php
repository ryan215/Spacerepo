            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
            	    <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:void(0);" style="background:0 !important;">
						...
						if((!empty($image))&&(file_exists('uploads/shipping/thumb50/'.$image)))
						{
						?>
                    ...
                    <ul class="dropdown-menu extended logout">
                        ...
                        <?php
						if(($this->session->userdata('userType')=='shipping')&&($this->session->userdata('userRole')=='DELIVERYAGENT'))
						{
						?>
                        <li>
							<a href="<?php echo base_url(); ?>shipping/profile/change_password">
