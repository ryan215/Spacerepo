...
<aside>
	<div id="sidebar"  class="nav-collapse " >
		...
		<div style="height:600px;overflow-y:scroll;overflow-x:hidden;">	
			...
			<li class="sub-menu">
            		<a href="<?php echo base_url(); ?>admin/marketing/slider_list" <?php if(($uriSeg2=='marketing')||($uriSeg2=='news_management')||($uriSeg2=='news_subscription_email')){ ?> class="dcjq-parent active" <?php } ?>>
                    ...
                    <ul class="sub">
                        ...
                        <li>
                            <a href="<?php echo base_url(); ?>admin/news_subscription_email" <?php if($uriSeg2=='news_subscription_email'){ ?> class="sun-menu-active" <?php } ?>>
			...
			<li class="sub" style="padding-bottom:80px;">
				<a href="javascript:void(0);" <?php if(($uriSeg2=='new_order')||($uriSeg2=='confirm_order')||($uriSeg2=='ready_to_shipped')||($uriSeg2=='shipped_in_transit')||($uriSeg2=='delivered_order')||($uriSeg2=='history_order')||($uriSeg2=='vendor_management')||($uriSeg2=='new_pickup_order')||($uriSeg2=='ready_to_pickup')||($uriSeg2=='order_picked_up')||($uriSeg2=='confirm_pickup_order')||($uriSeg2=='history_order_pickup')||($uriSeg2=='orders_management')){ ?> class="dcjq-parent active" <?php } ?>>
						<i class="fa fa-truck"></i>
						<span>Shipping Management</span>
					</a>
				<ul class="sub" style="height:450px;">
					<li>
						<a <?php if($uriSeg2=='orders_management'){ ?> class="sun-menu-active" <?php } ?> href="<?php echo base_url().'admin/orders_management'; ?>">
							<i class="fa fa-truck"></i>
			...
			?>
				...
				<a href="javascript:void(0);" <?php if(($uriSeg2=='vendor_management')||($uriSeg2=='orders_management')){ ?> class="dcjq-parent active" <?php } ?>>
						<i class="fa fa-truck"></i>
						<span>Shipping Management</span>
					</a>
					<li>
			...
			<li>
				<a href="<?php echo base_url().'admin/pointepay_management/retailerList'; ?>" <?php if($uriSeg2=='pointepay_management'){ ?> class="active" <?php } ?>>
					<i class="fa fa-user"></i>
					<span>PointePay Admin</span>
				</a>
			<ul class="sub">
						<li>
							<a href="<?php echo base_url().'admin/pointepay_management/retailerList'; ?>" class="sun-menu-active">
								Retailer Management 
							</a>
						</li>
						<li>
