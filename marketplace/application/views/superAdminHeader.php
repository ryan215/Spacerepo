...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/table_search_style.css">
	...
	<style>
	a.logo { margin-top:5px; margin-bottom:2px;}
	</style>
...
<section id="container" >
    ...
    <header class="header white-bg">
        ...
        <a href="javascript:void(0);" class="logo">
			<img width="200px" alt="avatar" src="<?php echo base_url(); ?>img/slogo.png" style="width: 200px; height: 55px;">
		</a>
        <!--logo end-->
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
            	    <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:void(0);" style="background:0 !important;">
						...
						{
						?>
							<img alt="" style="height:30px;width:30px;" src="<?php echo base_url(); ?>uploads/superadmin/thumb50/<?php echo $image; ?>">
						<?php
						}
						else
						{
                    ...
                    <ul class="dropdown-menu extended logout">
						...
						<li>
                       	...
                       	<li>
							<a href="<?php echo base_url(); ?>superadmin/profile/setting">
